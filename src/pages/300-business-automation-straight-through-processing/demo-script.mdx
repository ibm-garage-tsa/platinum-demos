...
| **Action** &nbsp; 7.1.5 | Click the arrows next to the two changes on the top left to display rule changes above the two decision diagrams. <br/><br/> <img src="./images/Step_7.1_action_5.png" width="800" /><br/> |
...
| **Action** &nbsp; 7.1.6 | Click **Reduce Manual Processing** at the top left side of the page. <br/><br/> <img src="./images/Step_7.1_action_6.png" width="800" /><br/> |
