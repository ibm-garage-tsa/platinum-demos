...
<InlineNotification>The first part of this section is for <strong>SaaS only</strong>. For <strong>ROKS</strong>, please go <a href="#ROKS">here</a>.</InlineNotification>
...
<InlineNotification>This section is for <strong>ROKS only</strong>. For <strong>SaaS</strong>, return to the <a href="#SaaS">top of section 2</a>.</InlineNotification><br/>
