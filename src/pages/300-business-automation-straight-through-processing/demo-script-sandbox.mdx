...
<summary>2 - Executing the workflow without straight-through processing (Workplace only)</summary>

<br/>

<InlineNotification>The first part of this section is for <strong>Workplace only</strong>. For <strong>SaaS</strong>, please go <a href="#SaaS">here</a>.</InlineNotification>
...
<summary>2a - Executing the workflow without straight-through processing (SaaS) </summary>

<br/>

<InlineNotification>This section is for <strong>SaaS only</strong>. For <strong>Workplace</strong>, return to the <a href="#Workplace">top of section 2</a>.</InlineNotification><br/>
