...
1. Log in to <a href="https://techzone.ibm.com/" target="_blank" rel="noreferrer">IBM Tech Zone site</a> using your IBM credentials.

<br/>

2. On the home page, click the **Activation kits** tab.
...
3. Click the **Cloud Pak for Integration Activation Kit**.
...
5. Select the latest version of the Express installation ROKS cluster.
...
<InlineNotification><strong>NOTE</strong> If there is no cluster available for Express installation, you can do a Custom installation. The process is the same, but the time for completion will be different. Express is a 5 minute request, because you will receive a pre-created ROKS cluster from a queue. Custom requires approximately 2 hours for provisioning.</InlineNotification>

<br/>

7. The ROKS environment should be ready after a few minutes. If this is your first time requesting a ROKS environment, an email will be sent to you with an invitation to join the ITZ IBM cloud account. Open the email, click **Join now**, and follow the steps to accept the invitation.<br/><br/> Your new cluster is available in this ITZ account. Take note of the account name as you will use it later to install CP4I.
