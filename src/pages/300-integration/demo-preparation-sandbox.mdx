...
Please note that use of the Demo Operator requires familiarity with creation of custom resources in OpenShift. If you do not have the required skillset to take the Demo Operator approach, please consider
continuing with demoPreparation set to true. Should this fail, you will have to either raise a ticket via the <a href="https://www.ibm.com/mysupport" target="_blank" rel="noreferrer">IBM Support Portal</a> for help.
