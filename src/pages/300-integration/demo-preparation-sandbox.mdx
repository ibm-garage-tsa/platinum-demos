...
Select the "Schedule for later" option and leave the start date and time information unchanged.
...
4. In approximately thirty minutes, you will recieve an email confirming your ROKS environment is ready. You are now ready to install Cloud Pak for Integration.<br/><br/>
