...
7. Scroll down to **Parameters with default values**. Click the collapsible section to open them. Change the default values parameters parameters using the table below.
...
<InlineNotification><strong>NOTE</strong>: Due to issues with the current provisioning mechanism, we will use the Demo Operator to complete installation and demo preparation.</InlineNotification>
