...
<div style="width:60%">
<img src="./images/demoscript-login1.png" alt="Login1"></img>
</div>

<div style="width:60%">
<img src="./images/demoscript-login2.png" alt="Login2"></img>
</div>
...
<div style="width:60%">
<img src="./images/demoscript-home.png" alt="Demoscript-Home"></img>
</div>
...
<div style="width:60%">
<img src="./images/demoscript-integration.png" alt="integration capabilities"></img>
</div>
...
<div style="width:60%">
<img src="./images/demoscript-createfromasset.png" alt="createfromasset"></img>
</div>
...
<div style="width:60%">
<img src="./images/demoscript-select-asset.png" alt="select-asset"></img>
</div>
...
**Screenshot**
![review1](./images/demoscript-review-props.png)
...
**Screenshot**
![review2](./images/demoscript-operations.png)
...
**Screenshot**
![review2](./images/demoscript-review-flow.png)
...
**Screenshot**
![review3](./images/demoscript-review-request.png)
...
**Screenshot**
![review5](./images/demoscript-review-if.png)
...
**Screenshot**
![review7](./images/demoscript-review-Salesforce-createcase.png)
...
**Screenshot**
![review8](./images/demoscript-review-attachment.png)
...
**Screenshot**
![review9](./images/demoscript-review-analyzer.png)
...
**Screenshots**
![review10](./images/demoscript-review-comment.png)
...
**Screenshot**
![review11](./images/demoscript-review-response.png)
...
**Screenshot**
![](./images/demoscript-start-flow.png)
...
**Screenshot**
![](./images/demoscript-variables2.png)

| **Action**             |  Execute **source exportVariables.sh** (10) |

**Screenshot**
![](./images/demoscript-variables3.png)
...
**Screenshot**
![](./images/demoscript-car-running1.png)

| **Action**             | Explore and close the file. Execute **./demotestcar.sh** (2). |

**Screenshot** ![](./images/demoscript-car-running2.png)
...
**Screenshot**
![Salesforce-check1](./images/demoscript-Salesforce-check1.png)

**Screenshot**
![](./images/demoscript-Salesforce-check2.png)

**Screenshot**
![](./images/demoscript-Salesforce-check3.png)
...
**Screenshot**
![](./images/demoscript-export-bar1.png)

| **Action**             | Select **Runtime flow asset (BAR)** (4) and click **Export** (5).  |

**Screenshot**
![](./images/demoscript-export-bar2.png)
...
**Screenshot**
![](./images/demoscript-import-bar6.png)|
...
**Screenshot**
![](./images/demoscript-verify-server1.png)

| **Action**             | Open our **API Flow** (2). |

**Screenshot**
![](./images/demoscript-verify-server2.png)

| **Action**             | Explore the API details (3). |

**Screenshot**
![](./images/demoscript-verify-server3.png)
...
**Action**
![](./images/demoscript-develop-api9.png)

**Action**
![](./images/demoscript-develop-api10.png)|
...
**Screenshot**
![](./images/demoscript-edit-api1.png)

| **Action**             | Change to **Online** (2). |

**Screenshot**
![](./images/demoscript-edit-api2.png)
...
**Screenshot**
![](./images/demoscript-edit-api3.png)|
...
**Screenshot**
![](./images/demoscript-access-portal1.png)
...
**Screenshot**
![](./images/demoscript-access-portal2.png)

| **Action**             | Complete the registration (5). |

**Screenshot**
![](./images/demoscript-access-portal3.png)

| **Action**             |  **Sign in** (6). |

**Screenshot**
![](./images/demoscript-access-portal4.png)|
...
**Screenshot**
![](./images/demoscript-subscription1.png)

| **Action**             | Click **Car Repair APIs 1.0.0** (2). |

**Screenshot**
![](./images/demoscript-subscription2.png)

| **Action**             | On **Gold Plan**, click **Subscribe** (3). |

**Screenshot**
![](./images/demoscript-subscription3.png)

| **Action**             | Select the **Car Repair Application** (4). |

**Screenshot**
![](./images/demoscript-subscription4.png)

| **Action**             | Confirm the subscription by clicking **Next** (5). |

**Screenshot**
![](./images/demoscript-subscription5.png)

| **Action**             | Click **Done** (6). |

**Screenshot**
![](./images/demoscript-subscription6.png)
...
**Screenshot**
![](./images/demoscript-portal-test1.png)

| **Action**             | Copy the **Endpoint** (2). Open the **POST /CarRepairClaim** (3). |

**Screenshot**
![](./images/demoscript-portal-test2.png)

| **Action**             | Explore the **Example request** area (4). |

**Screenshot**
![](./images/demoscript-portal-test3.png)

| **Action**             | Open the **Try it** tab (5). |

**Screenshot**
![](./images/demoscript-portal-test4.png)

| **Action**             | Click **Generate** (6). Click **Send** (7).  |

**Screenshot**
![](./images/demoscript-portal-test5.png)

| **Action**             | Explore the **Response** (8).|

**Screenshot**
![](./images/demoscript-portal-test6.png)|
...
**Screenshot**
![](./images/demoscript-statistics1.png)

| **Action**             | Click the **Car Repair APIs** (2). |

**Screenshot**
![](./images/demoscript-statistics2.png)

| **Action**             | Explore the API stats (3). |

**Screenshot**
![](./images/demoscript-statistics3.png) |
