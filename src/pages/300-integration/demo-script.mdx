...
| **Action** | 2.1.1. Click **Create from an Asset** <br/><br/> <img src="../images/300-api-demo-2-1-1.png" width=800 />|

| **2.2** | **Select an asset** |
| :--- | :--- |
| **Narration**  | Click on the **+** sign to the right on the **Car Insurance Cognitive API Lab Short V2**. |
| **Action** | 2.2.1. Click on the **+** sign to the right on the **Car Insurance Cognitive API Lab Short V2**. <br/><br/>  <img src="../images/300-api-demo-2-2-1.png" width=800 />|
