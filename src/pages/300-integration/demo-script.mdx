...
| **Action** | 2.1.1. Click **Create from an Asset** <br/><br/> <img src="https://raw.githubusercontent.com/cp4i-demo/platinum-demos/master/src/pages/300-integration/images/300-api-demo-2-1-1.png" width="800" />|

| **2.2** | **Select an asset** |
| :--- | :--- |
| **Narration**  | Click on the **+** sign to the right on the **Car Insurance Cognitive API Lab Short V2**. <br/>&nbsp;|
