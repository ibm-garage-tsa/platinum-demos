...
| **Actions**             | Change the contact **Full Name** to **Andrew Young** (2). **Test** the connection (3). |
...
| :---         | :--- |
| **Actions**             | Into the **Designer Dashboard** (1), click the **menu** (2) and click **Export** (3). |
...
| **Actions**             | Select **Runtime flow asset (BAR)** (4) and click **Export** (5).  |
| **Screenshot**         | &nbsp; <br/> ![demoscript-export-bar2](./images/demoscript-export-bar2.png) |

| **5.2 - Import the BAR file** |   |
| :---         | :--- |
| **Actions**             | Open the **Main Menu** (1), and click **Run > Integrations** (2). |
...
| **Actions**             | Select **Quick start designer integration** (4) and click **Next** (5). |
| **Screenshot**         | &nbsp; <br/> ![demoscript-import-bar3.png](./images/demoscript-import-bar3.png) |
| **Actions**             | **Upload the BAR** file (6) and click **Next** (7). |
| **Screenshot**         | &nbsp; <br/> ![demoscript-import-bar4.png](./images/demoscript-import-bar4.png) |
| **Actions**             | Select **ace-designerdemo-designer-acc** (8) and click **Next** (9). |
...
| **6.2 - Develop the API** |   |
| :---         | :--- |
| **Actions**             | Open the **menu** (1) and on **run** (2) section, select **APIs** (3). |
...
| **Actions**             | Click **Add**, then choose **API (from REST, GraphQL or SOAP)** from the drop-down menu (7). Choose **From an existing OpenAPI service** (8) and click **Next** (9). |
| **Screenshot**         | &nbsp; <br/> ![demoscript-develop-api5](./images/demoscript-develop-api5.png) |
| **Actions**             | Upload our **Car_Insurance..** YAML file (10) and click **Next** (11). |
| **Screenshot**         | &nbsp; <br/> ![demoscript-develop-api6](./images/demoscript-develop-api6.png) |
| **Actions**             | Confirm the info about API and click **Next** (12). |
| **Screenshot**         | &nbsp; <br/> ![demoscript-develop-api7](./images/demoscript-develop-api7.png) |
| **Actions**             | Keep the security settings and click **Next** (13). |
| **Screenshot**         | &nbsp; <br/> ![demoscript-develop-api8](./images/demoscript-develop-api8.png) |
| **Actions**             | Choose **From an existing OpenAPI service** (8) and click **Next** (9). Upload our **Car_Insurance..** YAML file (10) and click **Next** (11). Confirm the Info about API and click **Next** (12). Keep the security settings and click **Next** (13). |
...
| **Actions**             | Scroll down to **Base Path**. You’ll see the base path has a trailing slash at the end. **Remove** this (3). Click **Save** (4). Click **Test** (5). |
...
| **Actions**             | In your script folder, on **terminal** window, **edit** the **00-variables** file and update the **BASEPATH** and **CLIENTID** (3). |
...
| **6.5 - Publish the API** |   |
| :---         | :--- |
| **Actions**             | Open the **Menu** (1) and click **Publish** (2). |
...
| **Actions**             | Select **Catalog for Demo use (ddd-demo-test-catalog)** and click **Publish** (4). |
...
| **Actions**             | Back to the **Products** tab (9). Open the **Menu** and **Publish** the product (10). |
...
| **Actions**             | Open the **Manage** section. (13), open the **Catalog for Demo use** section (14), and check the product's **State** and **Plans** (15).
