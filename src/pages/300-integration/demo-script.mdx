...
![banner](./images/300-integration-script-github-banner.jpg)
<span id="place1"></span>
<details>
...
| :---         | :--- |
| **Action**             | Click **Create from an Asset**. |
...
| **Screenshot**         | &nbsp; <br/> ![Create from asset](./images/demoscript-createfromasset.png) |

| **2.2 - Select an asset** |   |
| :---         | :--- |
| **Action**             | Click on the **+** sign to the right on the **Car Insurance Cognitive API Lab Short V2**. |
| **Narration**      | We have a flow stored in the Asset Repository. Let’s use it to simplify our demonstration.|
| **Screenshot**         | &nbsp; <br/> ![Select asset](./images/demoscript-select-asset.png) |
...
| :---         | :--- |
| **Action**             | Show the **Properties view** and click on **Operations** |
...
| :---         | :--- |
| **Action**             | Show the **Operations view** and click on **Edit flow** |
...
<div style="width:60%">
<img src="./images/demoscript-operations.png" alt="operations"></img>
</div>
...
| **3.3 - Review the flow** |   |
| :---         | :--- |
| **Action**             | Initially **close** the Request dialog. Explain the Flow and Scroll through all of the connectors in the flow. After that, open the **Request** again, by clicking the first step of the flow. |
...
<div style="width:60%">
<img src="./images/demoscript-review-flow.png" alt="review2"></img>
</div>
...
| **3.4 - Review request** |   |
| :---         | :--- |
| **Action**             | Show the **Request** dialog (1). Click to *open* the **if** step (2). |
...
<div style="width:60%">
<img src="./images/demoscript-review-request.png" alt="review3"></img>
</div>
...
| :---         | :--- |
| **Action**             | Explore the *if* step (1) and click on **Salesforce Connector - Retrieve contacts** (2). |
| **Narration**      | Our flow starts by receiving the customer’s car repair request with photo via an API. Designer automatically creates an API “request” and “response” for your API flow. |
...
<div style="width:60%">
<img src="./images/demoscript-contacts1.png" alt="contact"></img>
</div>

| **Action**             | Change the contact **Full Name** to **Andrew Young** (2). **Test** the connection (3). |

<div style="width:60%">
<img src="./images/demoscript-contacts2.png" alt="contacts2"></img>
</div>

<br/>

| **Action**             |  Change the contact **Full Name** back to Andy Young (4). **Test** again. (5). Open **View details**. (6). |

<div style="width:60%">
<img src="./images/demoscript-contacts3.png" alt="contacts3"></img>
</div>
...
<div style="width:60%">
<img src="./images/demoscript-contacts4.png" alt="contacts4"></img>
</div>

<br/>

| **Action**             | **Close** all the dialog tabs. Click on the **Salesforce – Create case node** (8). |

<div style="width:60%">
<img src="./images/demoscript-contacts5.png" alt="contact5"></img>
</div>
...
| **3.7 - Create a case** |   |
| :---         | :--- |
| **Action**             | Explore the **Salesforce – Create case node**. **Close** the Salesforce connector dialog. Open the **Salesforce - Create Attachment** node. |
...
<div style="width:60%">
<img src="./images/demoscript-review-Salesforce-createcase.png" alt="create-case"></img>
</div>
...
| :---         | :--- |
| **Action**             | Explore the *Salesforce – Create attachment node* (1). **Close** the Salesforce connector dialog. Open the **IBM Watson Tone Analyzer** node (2). |
...
<div style="width:60%">
<img src="./images/demoscript-review-attachment.png" alt="demoscript-review-attachment"></img>
</div>
...
| :---         | :--- |
| **Action**             | Explore the **Watson Tone Analyzer** connector (1). **Close** the Tone Analyzer connector dialog. Open the **Salesforce - Create case comment** (2). |
...
<div style="width:60%">
<img src="./images/demoscript-review-analyzer.png" alt="demoscript-review-analyzer"></img>
</div>
...
| :---         | :--- |
| **Action**             | Explore the **Salesforce – Create case comment** node (1). Close the Salesforce connector dialog. Open the **Response**. (2) |
...
<div style="width:60%">
<img src="./images/demoscript-review-comment.png" alt="demoscript-review-comment"></img>
</div>
...
| :---         | :--- |
| **Action**             | Explore the **Response** dialog (1). Click **Done** (2). |
...
<div style="width:60%">
<img src="./images/demoscript-review-response.png" alt="demoscript-review-response"></img>
</div>
...
<div style="width:60%">
<img src="./images/demoscript-start-flow.png" alt="demoscript-start-flow"></img>
</div>
...
| :---         | :--- |
| **Action**             | Open the **Test** tab (1). Copy the **Endpoint URL** (2). |

<div style="width:60%">
<img src="./images/demoscript-variables0.png" alt="demoscript-variables"></img>
</div>

| **Action**             | Open **POST /CarRepairClaim** (3). Open **Try it** (4).  Copy the **Username** (5) and **Password** (6).

<div style="width:60%">
<img src="./images/demoscript-variables1.png" alt="demoscript-variables1"></img>
</div>

| **Action**             | In your script folder, on **terminal** window, **edit** the **00-variables** file (e.g.: *vi 00-variables*) and update the **BASEPATH** (7), **USERNAME** (8) and **PASSWORD** (9). |

<div style="width:60%">
<img src="./images/demoscript-variables2.png" alt="demoscript-variables2"></img>
</div>

| **Action**             |  Execute **source exportVariables.sh** (10) |

<div style="width:60%">
<img src="./images/demoscript-variables3.png" alt="demoscript-variables3"></img>
</div>
...
<div style="width:60%">
<img src="./images/demoscript-car-running1.png" alt="demoscript-car-running1"></img>
</div>

| **Action**             | Explore and close the file. Execute **./demotestcar.sh** (2). |

<div style="width:60%">
<img src="./images/demoscript-car-running2.png" alt="demoscript-car-running2"></img>
</div>
...
| :---         | :--- |
| **Action**             | Open the **Salesforce Dev Account** site (1). On the **App Launcher** menu, search for **Cases** (2). |

| **Action**             | Open the **Cases** page (3). On *Cases* view, open the latest **Car Breakdown case** (4). Explore all fields, including picture and Watson analysis (5).  |

<div style="width:60%">
<img src="./images/demoscript-Salesforce-check1.png" alt="Salesforce-check1"></img>
</div>

<div style="width:60%">
<img src="./images/demoscript-Salesforce-check2.png" alt="Salesforce-check2"></img>
</div>

<div style="width:60%">
<img src="./images/demoscript-Salesforce-check3.png" alt="Salesforce-check3"></img>
</div>
...
| :---         | :--- |
| **Action**             | Into the **Designer Dashboard** (1), click the **menu** (2) and click **Export** (3). |

<div style="width:60%">
<img src="./images/demoscript-export-bar1.png" alt="demoscript-export-bar1"></img>
</div>

| **Action**             | Select **Runtime flow asset (BAR)** (4) and click **Export** (5).  |

<div style="width:60%">
<img src="./images/demoscript-export-bar2.png" alt="demoscript-export-bar2"></img>
</div>
...
| :---         | :--- |
| **Action**             | Open the **Main Menu** (1), and click **Run > Integrations** (2). |

<div style="width:60%">
<img src="./images/demoscript-import-bar1.png" alt="demoscript-import-bar1.png"></img>
</div>

| **Action**             | Click **Create a server** (3). |

<div style="width:60%">
<img src="./images/demoscript-import-bar2.png" alt="demoscript-import-bar2.png"></img>
</div>

| **Action**             | Select **Quick start designer integration** (4) and click **Next** (5). |

<div style="width:60%">
<img src="./images/demoscript-import-bar3.png" alt="demoscript-import-bar3.png"></img>
</div>

| **Action**             | **Upload the BAR** file (6) and click **Next** (7). |

<div style="width:60%">
<img src="./images/demoscript-import-bar4.png" alt="demoscript-import-bar4.png"></img>
</div>

| **Action**             | Select **ace-designerdemo-designer-acc** (8) and click **Next** (9). |

<div style="width:60%">
<img src="./images/demoscript-import-bar5.png" alt="demoscript-import-bar5.png"></img>
</div>

| **Action**             | Enter a **name** for our integration server (10). Set **Enable Operations Dashboard tracing** to **On** (11). Enter **cp4i** as *Operations Dashboard namespace (12). Click **Create** (13)   |

<div style="width:60%">
<img src="./images/demoscript-import-bar6.png" alt="demoscript-import-bar6.png"></img>
</div>
...
<div style="width:60%">
<img src="./images/demoscript-verify-server1.png" alt="demoscript-verify-server1"></img>
</div>

| **Action**             | Open our **API Flow** (2). |

<div style="width:60%">
<img src="./images/demoscript-verify-server2.png" alt="demoscript-verify-server2"></img>
</div>

| **Action**             | Explore the API details (3). |

<div style="width:60%">
<img src="./images/demoscript-verify-server3.png" alt="demoscript-verify-server3"></img>
</div>
...
<div style="width:60%">
<img src="./images/demoscript-testing-runtime1.png" alt="demoscript-testing-runtime1"></img>
</div>

| **Action**             | In your script folder, on **terminal** window, **edit** the **00-variables** file and update the **BASEPATH** (2). |

<div style="width:60%">
<img src="./images/demoscript-testing-runtime2.png" alt="demoscript-testing-runtime2"></img>
</div>

| **Action**             | ***NOTE:remove the "/" from the end of the endpoint***. Execute **source exportVariables.sh** (3). |

<div style="width:60%">
<img src="./images/demoscript-testing-runtime3.png" alt="demoscript-testing-runtime3"></img>
</div>

| **Action**             | Execute **./demotestcar.sh** (4). |

<div style="width:60%">
<img src="./images/demoscript-testing-runtime4.png" alt="demoscript-testing-runtime4"></img>
</div>

| **Action**             | Check the **new case** in *Salesforce* (5).|

<div style="width:60%">
<img src="./images/demoscript-testing-runtime5.png" alt="demoscript-testing-runtime5"></img>
</div>
...
<div style="width:60%">
<img src="./images/demoscript-download-openapi.png" alt="demoscript-download-openapi.png"></img>
</div>

| **Actions**             | Open your YAML file with any editor and manually add **x-ibm-configuration: gateway: datapower-api-gateway** (2). |

<div style="width:60%">
<img src="./images/demoscript-download-openapi2.png" alt="demoscript-download-openapi2.png"></img>
</div>
...
| **6.2 - Develop the API** |   |
| :---         | :--- |
| **Action**             | Open the **Menu** (1) and on **Run** (2) section, select **APIs** (3). |

<div style="width:60%">
<img src="./images/demoscript-develop-api1.png" alt="demoscript-develop-api1"></img>
</div>

| **Action**             | If necessary, select the **ademo** instance (4). |

<div style="width:60%">
<img src="./images/demoscript-develop-api2.png" alt="demoscript-develop-api2"></img>
</div>

| **Action**             | In the **API Connect** page, click **Common Services user registry** (5). |

<div style="width:60%">
<img src="./images/demoscript-develop-api3.png" alt="demoscript-develop-api3"></img>
</div>
...
<div style="width:60%">
<img src="./images/demoscript-develop-api4.png" alt="demoscript-develop-api4"></img>
</div>

| **Action**             | Click **Add**, then choose **API (from REST, GraphQL or SOAP)** from the drop-down menu (7). |

| **Action**             | Choose **From an existing OpenAPI service** (8) and click **Next** (9). |

<div style="width:60%">
<img src="./images/demoscript-develop-api5.png" alt="demoscript-develop-api5"></img>
</div>

| **Action**             | Upload our **Car_Insurance..** YAML file (10) and click **Next** (11). |

<div style="width:60%">
<img src="./images/demoscript-develop-api6.png" alt="demoscript-develop-api6"></img>
</div>

| **Action**             | Confirm the Info about API and click **Next** (12). |

<div style="width:60%">
<img src="./images/demoscript-develop-api7.png" alt="demoscript-develop-api7"></img>
</div>

| **Action**             | Keep the security settings and click **Next** (13). |

<div style="width:60%">
<img src="./images/demoscript-develop-api8.png" alt="demoscript-develop-api8"></img>
</div>

| **Action**             | Choose **From an existing OpenAPI service** (8) and click **Next** (9). Upload our **Car_Insurance..** YAML file (10) and click **Next** (11). Confirm the Info about API and click **Next** (12). Keep the security settings and click **Next** (13). |

<div style="width:60%">
<img src="./images/demoscript-develop-api9.png" alt="demoscript-develop-api9"></img>
</div>

<div style="width:60%">
<img src="./images/demoscript-develop-api10.png" alt="demoscript-develop-api10"></img>
</div>
...
<div style="width:60%">
<img src="./images/demoscript-edit-api1.png" alt="demoscript-edit-api1"></img>
</div>

| **Action**             | Change to **Online** (2). |

<div style="width:60%">
<img src="./images/demoscript-edit-api2.png" alt="demoscript-edit-api2"></img>
</div>

| **Action**             | Scroll down to **Base Path**. You’ll see the base path has a trailing slash at the end. **Remove** this (3). Click **Save** (4). Click **Test** (5). |

<div style="width:60%">
<img src="./images/demoscript-edit-api3.png" alt="demoscript-edit-api3"></img>
</div>
...
| **6.4 - Test the API** |   |
| :---         | :--- |
| **Action**             | Copy the **POST URL** (remove */CarRepairClaim*) (1). Copy the **X-IBM-Client-Id** (2). |
<br/>

<div style="width:60%">
<img src="./images/demoscript-test-apic1.png" alt="demoscript-test-apic1"></img>
</div>

<div style="width:60%">
<img src="./images/demoscript-test-apic2.png" alt="demoscript-test-apic2"></img>
</div>

| **Action**             | In your script folder, on **terminal** window, **edit** the **00-variables** file and update the **BASEPATH** and **CLIENTID** (3). |

<div style="width:60%">
<img src="./images/demoscript-test-apic3.png" alt="demoscript-test-apic3"></img>
</div>

| **Action**             | Execute **source exportVariables.sh** (4). |

<div style="width:60%">
<img src="./images/demoscript-test-apic4.png" alt="demoscript-test-apic4"></img>
</div>
...
| **6.5 - Publish the API** |   |
| :---         | :--- |
| **Action**             | Open the **Menu** (1) and click **Publish** (2). |

<div style="width:60%">
<img src="./images/demoscript-publish-api1.png" alt="demoscript-publish-api1"></img>
</div>

| **Action**             | Enter **Car Repair APIs** as **Product Title** (3). |

<div style="width:60%">
<img src="./images/demoscript-publish-api2.png" alt="demoscript-publish-api2"></img>
</div>

| **Action**             | Select **Catalog for Demo use (ddd-demo-test-catalog)** and click **Publish** (4). |

<div style="width:60%">
<img src="./images/demoscript-publish-api3.png" alt="demoscript-publish-api3"></img>
</div>

| **Action**             | See publish confirmation message (5). |

<div style="width:60%">
<img src="./images/demoscript-publish-api4.png" alt="demoscript-publish-api4"></img>
</div>
...
| :---         | :--- |
| **Action**             | Open the **Products** tab (1). Click on the **Car Repair APIs** product (2). |

<div style="width:60%">
<img src="./images/demoscript-rate-limit1.png" alt="demoscript-rate-limit1"></img>
</div>

| **Action**             | Click on **Plans** (3). Click **Add** (4). |

<div style="width:60%">
<img src="./images/demoscript-rate-limit2.png" alt="demoscript-rate-limit2"></img>
</div>

| **Action**             | Enter **gold plan** as **Title** (5). Change the **Rate Limits** to **100 Calls Per 1 minute** (6). Click **Save** (7). |

<div style="width:60%">
<img src="./images/demoscript-rate-limit3.png" alt="demoscript-rate-limit3"></img>
</div>

| **Action**             | Open the **Develop** page (8). |

<div style="width:60%">
<img src="./images/demoscript-rate-limit4.png" alt="demoscript-rate-limit4"></img>
</div>

| **Action**             | Back to the **Products** tab (9). Open the **Menu** and **Publish** the product (10). |

<div style="width:60%">
<img src="./images/demoscript-rate-limit5.png" alt="demoscript-rate-limit5"></img>
</div>

| **Action**             | Select the **Catalog for Demo use** (11). Click **Publish** (12). |

<div style="width:60%">
<img src="./images/demoscript-rate-limit6.png" alt="demoscript-rate-limit6"></img>
</div>

| **Action**             | Open the **Manage** section. (13), open the **Catalog for Demo use** section (14), and check the product's **State** and **Plans** (15).

<div style="width:60%">
<img src="./images/demoscript-rate-limit7.png" alt="demoscript-rate-limit7"></img>
</div>
...
| :---         | :--- |
| **Action**             | Open the **Catalog settings** (1). Click **Portal** (2). Copy the **Portal URL** (3). |

<div style="width:60%">
<img src="./images/demoscript-access-portal1.png" alt="demoscript-access-portal1"></img>
</div>
...
<div style="width:60%">
<img src="./images/demoscript-access-portal2.png" alt="demoscript-access-portal2"></img>
</div>

| **Action**             | Complete the registration (5). |

<div style="width:60%">
<img src="./images/demoscript-access-portal3.png" alt="demoscript-access-portal3"></img>
</div>

| **Action**             |  **Sign in** (6). |

<div style="width:60%">
<img src="./images/demoscript-access-portal4.png" alt="demoscript-access-portal4"></img>
</div>
...
<div style="width:60%">
<img src="./images/demoscript-new-app1.png" alt="demoscript-new-app1"></img>
</div>

| **Action**             | Enter **Car Repair Application** as **App Title** (2). Click **Save** (3). |

<div style="width:60%">
<img src="./images/demoscript-new-app2.png" alt="demoscript-new-app2"></img>
</div>

| **Action**             | On the credentials dialog, click **OK** (4). |

<div style="width:60%">
<img src="./images/demoscript-new-app3.png" alt="demoscript-new-app3"></img>
</div>

| **Action**             | On the **Subscription** tab, copy the client ID (5). |

<div style="width:60%">
<img src="./images/demoscript-new-app4.png" alt="demoscript-new-app4"></img>
</div>
...
<div style="width:60%">
<img src="./images/demoscript-subscription1.png" alt="demoscript-subscription1"></img>
</div>

| **Action**             | Click **Car Repair APIs 1.0.0** (2). |

<div style="width:60%">
<img src="./images/demoscript-subscription2.png" alt="demoscript-subscription2"></img>
</div>

| **Action**             | On **Gold Plan**, click **Subscribe** (3). |

<div style="width:60%">
<img src="./images/demoscript-subscription3.png" alt="demoscript-subscription3"></img>
</div>
![]()
...
<div style="width:60%">
<img src="./images/demoscript-subscription4.png" alt="demoscript-subscription4"></img>
</div>

| **Action**             | Confirm the subscription by clicking **Next** (5). |

<div style="width:60%">
<img src="./images/demoscript-subscription5.png" alt="demoscript-subscription5"></img>
</div>

| **Action**             | Click **Done** (6). |

<div style="width:60%">
<img src="./images/demoscript-subscription6.png" alt="demoscript-subscription6"></img>
</div>
...
<div style="width:60%">
<img src="./images/demoscript-portal-test1.png" alt="demoscript-portal-test1.png"></img>
</div>

| **Action**             | Copy the **Endpoint** (2). Open the **POST /CarRepairClaim** (3). |
...
| **Action**             | Click **Generate** (6). Click **Send** (7).  |
...
| :---         | :--- |
| **Action**             | Click **Apps** on top menu (1). Click the **Car Repair APIs** (2). Explore the API stats (3). |
