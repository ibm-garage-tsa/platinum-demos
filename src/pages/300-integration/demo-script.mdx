...
<br/>
(Printer-ready PDF of demo script [here](link))
<br/>
</details>
...
| :--- | :--- |
| **Actions** | Open Cloud Pak for Integration<br/> <br/>Click **IBM provided credentials (admin only)**<br/><br/>**Log in** with your admin user and password |
...
| :--- | :--- |
| **Actions** | Show the home screen<br/> <br/>Click on **Integration Capabilities** |
