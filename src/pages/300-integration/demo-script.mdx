...
| **Actions** | 1. Open Cloud Pak for Integration <br/> <br/> 2. Click **IBM provided credentials (admin only)** <br/> <br/> ![login1](./images/300-api-demo-1-1-1.png)<br/> <br/> 3. **Log in** with your admin user and password <br/> <br/> ![login2](./images/300-api-demo-1-1-2.png)|
...
| **Actions** | 1. Show the **Home Page**.<br/><br/>2. Click on **Integration Capabilities**. <br/> <br/> ![](./images/300-api-demo-1-2-1.png) |
...
| **Actions** | 1. Show the **Integration Capabilities** page.<br/> <br/>2. Open the Integration dashboard (ace-dashboard-demo).<br/> <br/> ![](./images/300-api-demo-1-3-1.png)|
