---
title: Improving customer service using APIs and integration 300-level live demo
...
| **Narration**      | Second, we validate the photo. Here, we have a simple if statement, that check if the PhotoOfCar is empty. |
