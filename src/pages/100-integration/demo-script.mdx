...
| :---         | :--- |
| **Actions**             | Open the **Menu** (1) and on **Run** (2) section, select **APIs** (3)<br/><br/>
If necessary, select the **ademo** instance (4)<br/><br/>In the *API Connect* page, click **LDAP User Registry for Outcomes** (5)<br/><br/>**Log in** with your Outcomes user and password (6) |
