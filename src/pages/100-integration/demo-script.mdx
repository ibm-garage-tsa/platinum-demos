...
| **Actions** | 1.1.1.Open **Cloud Pak for Integration**. Click **Enterprise LDAP**.<br/><br/>![login1](./images/100-api-demo-1-1-1.png)<br/><br/>1.1.2.**Log in** with your **username** and **password**.<br/><br/>![login2](./images/100-api-demo-1-1-2.png)<br/><br/>|
...
| **Actions** | 1.2.1.Show the **Home page** (1). Open the **Menu** (2) and click on **Administration > Integration Capabilities** (3).<br/><br/>![home](./images/100-api-demo-1-2-1.png)<br/><br/>|
...
| **Actions** | 1.3.1.Show the **Integration Capabilities** page. Open the Designer (**ace-designer-demo**).<br/><br/>![integration capabilities](./images/100-api-demo-1-3-1.png) <br/><br/>|
...
| **Actions** | 2.1.1.Select **Car Insurance Cognitive API Lab Short V2** flow.<br/><br/>![review1](./images/100-api-demo-2-1-1.png)<br/><br/>2.1.2.Show the **Properties view**.Click on **Operations**.<br/><br/>![review1](./images/100-api-demo-2-1-2.png)<br/><br/>|
...
| **Actions** | 2.2.1.Show the **Operations view**. Click on **View flow**.<br/><br/> ![review2](./images/100-api-demo-2-2-1.png)<br/><br/>|
...
| **Actions** | 2.3.1.Explain the **flow** and scroll through all of the **connectors** in the flow. Open the **Request** by clicking the **first step** of the flow. <br/><br/>![review2](./images/100-api-demo-2-3-1.png)<br/><br/>|
...
| **Actions** | 2.4.1.Show the **Request** dialog (1). Click to open the **IF** step (2). <br/><br/>![review3](./images/100-api-demo-2-4-1.png) <br/><br/> |
...
| **Actions** | 2.5.1.Explore the **IF** step (1). Click on **Salesforce Connector - Retrieve contacts** (2). <br/><br/>![review5](./images/100-api-demo-2-5-1.png)<br/><br/> |
...
| **Actions** | 2.6.1.Explore the **Salesforce Connector - Retrieve contacts** (1). Click on the **Salesforce – Create case** node (2). <br/><br/> ![contacts1](./images/100-api-demo-2-6-1.png) <br/><br/>|
...
| **Actions** | 2.7.1.Explore the **Salesforce – Create case** node (1). Open the **Salesforce - Create Attachment** node (2). <br/><br/> ![review7](./images/100-api-demo-2-7-1.png) <br/><br/> |
...
| **Actions** | 2.8.1.Explore the **Salesforce – Create Attachment node** (1). Open the **IBM Watson Tone Analyzer** node (2). <br/><br/> ![review8](./images/100-api-demo-2-8-1.png) <br/><br/> |
...
| **Actions** | 2.9.1.Explore the **Watson Tone Analyzer** connector (1). Open the **Salesforce - Create case comment** (2). <br/><br/> ![review9](./images/100-api-demo-2-9-1.png) <br/><br/> |
...
| **Actions** | 2.10.1.Explore the **Salesforce – Create case comment** node (1). Open the **Response** (2). <br/><br/> ![review10](./images/100-api-demo-2-10-1.png) <br/><br/>|
...
| **Actions** | 2.11.1.Explore the **Response** dialog (1). Click **Done** (2). <br/><br/>![review11](./images/100-api-demo-2-11-1.png)<br/><br/> |
...
| **Actions** | 3.1.1.Open the **Menu** (1) and on **Run** (2) section, select **APIs** (3)<br/><br/>![](./images/100-api-demo-3-1-1.png) <br/><br/>3.1.2.In the *API Connect* page, click **openldap Outcomes**.<br/><br/>![](./images/100-api-demo-3-1-2.png)<br/><br/>3.1.3.**Log in** with your Outcomes user and password.<br/><br/> ![](./images/100-api-demo-3-1-3.png)<br/><br/> |
...
| **Actions** | 3.2.1.Click **Develop APIs and Products**.<br/><br/>![](./images/100-api-demo-3-2-1.png)<br/><br/>3.2.2.Click **Car_Insurance_Cognitive_API_Lab_Short_V2**.<br/><br/>![](./images/100-api-demo-3-2-2.png)<br/><br/>3.2.3.Open **Security Schemes** (1). Explore the **Security Schemes** page (2). Then, click **Develop** on breadcrumbs (3) <br/><br/>![](./images/100-api-demo-3-2-3.png)<br/><br/> |
...
| **Actions** | 3.3.1.Click **Products** (1). Click **Car Repair APIs** product (2).<br/><br/>![](./images/100-api-demo-3-3-1.png)<br/><br/>3.3.2.Open the **Plans** (1) tab. Open the context menu of **Gold Plan** and select **Edit** (2).<br/><br/>![](./images/100-api-demo-3-3-2.png)<br/><br/>3.3.3.Explore the **Rate Limits** section.<br/><br/>![](./images/100-api-demo-3-3-3.png)<br/><br/>3.3.4.Just show how simple is to publish the Product and API, clicking **Menu > Publish**. *Note: you don't need to publish, because the product is already published.*<br/><br/> ![](./images/100-api-demo-3-3-4.png)<br/><br/> |
...
| **Actions** | 4.1.1.On the left navigator menu, open **Manage** page (1). Open the **Sandbox** catalog (2).<br/><br/>![](./images/100-api-demo-4-1-1.png)<br/><br/>4.1.2.Open the **Catalog settings** (1). Click **Portal** (2). Copy the **Portal URL** (3).<br/><br/>![](./images/100-api-demo-4-1-2.png)<br/><br/>4.1.3.Open a new Browser tab and access the Portal URL. Create a developer account by clicking **Create account**.<br/><br/>![](./images/100-api-demo-4-1-3.png)<br/><br/>4.1.4.Use your personal email to complete the registration<br/><br/>![](./images/100-api-demo-4-1-4.png)<br/><br/>4.1.5.You need to access your email to accept the invitation, and then **sign in**. <br/><br/>![](./images/100-api-demo-4-1-5.png)<br/><br/> |
...
| **Actions** | 4.2.1.Click **Create a new App**. <br/><br/>![](./images/100-api-demo-4-2-1.png)<br/><br/>4.2.2.Enter **"Car Repair Application"** as *App Title* (1). Click **Save** (2)<br/><br/>![](./images/100-api-demo-4-2-2.png)<br/><br/>4.2.3. On the credentials dialog, click **OK**.<br/><br/>![](./images/100-api-demo-4-2-3.png)<br/><br/>4.2.4.On the **Subscription** tab, copy the Client ID.<br/><br/>![](./images/100-api-demo-4-2-4.png)<br/><br/> |
...
| **Actions** | 4.3.1.Click **Why not browse the available APIs?**.<br/><br/>![](./images/100-api-demo-4-3-1.png)<br/><br/>4.3.2.Click **Car Repair APIs 1.0.0**.<br/><br/>![](./images/100-api-demo-4-3-2.png)<br/><br/>4.3.3.On *Gold Plan* section, click on **Select** button.<br/><br/>![](./images/100-api-demo-4-3-3.png)<br/><br/>4.3.4.Select the **Car Repair Application**.<br/><br/>![](./images/100-api-demo-4-3-4.png)<br/><br/>4.3.5.Confirm the subscription by clicking **Next**.<br/><br/>![](./images/100-api-demo-4-3-5.png)<br/><br/>4.3.6.Click **Done**.<br/><br/>![](./images/100-api-demo-4-3-6.png)<br/><br/> |
...
| **Actions** | 4.4.1.Click on the **Car_Insurance API** itself.<br/><br/>![](./images/100-api-demo-4-4-1.png)<br/><br/>4.4.2.Open the **POST/CarRepairClaim**.<br/><br/>![](./images/100-api-demo-4-4-2.png)<br/><br/>4.4.3.Explore the **Example request** area.<br/><br/>![](./images/100-api-demo-4-4-3.png)<br/><br/>4.4.4.Open the **Try it** tab.<br/><br/>![](./images/100-api-demo-4-4-4.png)<br/><br/>4.4.5.Click **Generate** (1) and Click **Send** (2).<br/><br/>![](./images/100-api-demo-4-4-5.png)<br/><br/>4.4.6. Explore the **Response**.<br/><br/>![](./images/100-api-demo-4-4-6.png)<br/><br/> |
...
| **Actions** | 4.5.1.Click on **Apps** on the top menu.<br/><br/>![](./images/100-api-demo-4-5-1.png)<br/><br/>4.5.2.Click on the **Car Repair Application**.<br/><br/>![](./images/100-api-demo-4-5-2.png)<br/><br/>4.5.3.Explore the API stats.<br/><br/>![](./images/100-api-demo-4-5-3.png)<br/><br/> |
