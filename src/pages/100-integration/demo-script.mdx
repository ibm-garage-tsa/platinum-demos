...
| :---         | :--- |
| **Action**             | Open Cloud Pak for Integration and click **Enterprise LDAP** and **Log in** with your user and password. |
...
| **Screenshot**         | &nbsp;  <br/> ![login1](./images/outcomes-login.png) <br/> ![login2](./images/outcomes-username.png) |

| **1.2 - Cloud Pak for Integration home** |   |
| :---         | :--- |
| **Action** | Show the home page and open the **menu**, click on **Administration > Integration Capabilities**. |
...
| :---         | :--- |
| **Action**             | Select **Car Insurance Cognitive API Lab Short V2** flow. Show the **Properties view** and click on **Operations** |
...
| **Screenshot**         | &nbsp;  <br/> ![review1](./images/car-insurance-flow.png) <br/> ![review1](./images/demoscript-review-props.png) |

| **2.2 - Reviewing operations** |   |
| :---         | :--- |
| **Action**             | Show the **Operations view** and click on **View flow** |
...
| :---         | :--- |
| **Action**             | Explain the flow and scroll through all of the connectors in the flow. After that, open the **Request** again, by clicking the first step of the flow. |
...
| :---         | :--- |
| **Action**             | Explore the **Salesforce Connector - Retrieve contacts** (1). **Close** all the dialog tabs. Click on the **Salesforce – Create case node** (8). |
...
| **Screenshot**         | &nbsp;  <br/> ![contacts1](./images/demoscript-contacts1.png) <br/> ![contacts5](./images/demoscript-contacts5.png)|
...
| :---         | :--- |
| **Action**             | Open the **Menu** and select **Run > Integration**. Select the **ace-dashboard-demo** instance. Click on **Servers**. Select **carrepair-server**. Open our **API Flow** (2). Explore the API details (3). |
...
| **Screenshot**         | &nbsp; <br/> ![](./images/integration-runtime.png) <br/> ![](./images/ace-dashboard-demo.png) <br/> ![](./images/integration-servers.png) <br/> ![](./images/carrepair-server.png) <br/> ![](./images/demoscript-verify-server2.png) <br/> ![](./images/demoscript-verify-server3.png) |
...
| :---         | :--- |
| **Action**             | Open the **Menu** (1) and on **Run** (2) section, select **APIs** (3). If necessary, select the **ademo** instance (4). In the *API Connect* page, click **LDAP User Registry for Outcomes** (5). **Log in** with your Outcomes user and password (6). |
...
| **Screenshot**         |  &nbsp;  <br/> ![](./images/demoscript-develop-api1.png) <br/> ![](./images/demoscript-develop-api2.png) <br/> ![](./images/apic-ldap.png) <br/> ![](./images/apic-outcomes-login.png) |

| **3.2 - Developing an API** |   |
| :---         | :--- |
| **Action**             | Click **Develop APIs and Products** (1). Click **Car_Insurance_Cognitive_API_Lab_Short_V2** (2), then open **Security definitions** (3). Explore the *Security definitions* page (4). Click **Develop** on breadcrumbs (5). |
| **Narration** &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; | Now, let's check our API here in API manager. To simplify the demo, our API is pre-assembled here in the API Manager. In the develop page, we are able to edit, assemble, secure and test APIs. In the security definitions, we can control client access to API endpoints, for example using API key validation.  |
| **Screenshot**         | &nbsp;  <br/> ![](./images/develop-api-1.png) <br/> ![](./images/develop-api-2.png) <br/> ![](./images/develop-api-3.png) |

| **3.3 - Developing a product** |   |
| :---         | :--- |
| **Action**             | Click **Products** (1). Click **Car Repair APIs** product (2).  Open the **Plans** (3) tab. And on the context menu of *Gold Plan* and select **Edit** (4).  Explore the **Rate Limits** section (5). Just show, how simple is to publish the Product and API, clicking **Menu > Publish** (6) (Note: you don't need to publish, because the product is already published). |
...
| **Screenshot**         | &nbsp; <br/> ![](./images/manage-sandbox.png) <br/> ![](./images/demoscript-access-portal1.png) <br/> ![](./images/demoscript-access-portal2.png) <br/> ![](./images/demoscript-access-portal3.png) <br/> ![](./images/demoscript-access-portal4.png)|

| **4.2 - Creating a new App** |   |
| :---         | :--- |
| **Action**             | Click **Create a new App** (1). Enter **Car Repair Application** as *App Title* (2). Click **Save** (3). On the credentials dialog, click **OK** (4). On the **Subscription** tab, copy the Client ID (5). |
...
| **Screenshot**         | &nbsp;  <br/> ![](./images/demoscript-new-app1.png) <br/> ![](./images/demoscript-new-app2.png) <br/> ![](./images/demoscript-new-app3.png) <br/> ![](./images/demoscript-new-app4.png)|

| **4.3 - Subscribing to API** |   |
| :---         | :--- |
| **Action**             | Click **Why not browse the available APIs?** (1). Click **Car Repair APIs 1.0.0** (2). On *Gold Plan*, click **Subscribe** (3). Select the **Car Repair Application** (4). Confirm the Subscription by clicking **Next** (5). Click **Done** (6). |
...
| **4.4 - Testing the API** |   |
| :---         | :--- |
| **Action**             | Click on the **Car_Insurance API** itself (1). Copy the **Endpoint** (2). Open the **POST /CarRepairClaim** (3). Explore the **Example request** area (4). Open the **Try it** tab (5). Click **Generate** (6). Click **Send** (7). Explore the **Response** (8).|
...
| :---         | :--- |
| **Action**             | Click **Apps** on top menu (1). Click the **Car Repair Application** (2). Explore the API stats (3). |
...
| **Screenshot**         | &nbsp;  <br/> ![](./images/demoscript-statistics1.png) <br/> ![](./images/demoscript-statistics2.png) <br/> ![](./images/demoscript-statistics3.png) |
