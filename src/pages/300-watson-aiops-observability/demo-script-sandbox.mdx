...
| **Action** &nbsp; 1.1.3 | Hover the cursor over a few of the icons to show info on what technology they are built on. For example, we can see how the catalogue-demo is built on http, Java Virtual Machine (JVL), and Spring Boot, while the catalogue database is built on MongoDB. <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-watson-aiops-observability/images/hover-icons.png" width="800" /> |
