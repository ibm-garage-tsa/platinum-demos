...
| **Action** &nbsp; 2.1.2 | Hover over to show **Incident Timeline**, **Triggering Event**, and **Related Events**. <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-watson-aiops-observability/images/incident_details_screen.png" width="800" /> |
...
| **Action** &nbsp; 3.2.1 | Click the endpoint named **CONNECT** (1). Then, click the first call (also named **CONNECT** (2)). <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-watson-aiops-observability/images/endpoint_connect.png" width="800" /> |
