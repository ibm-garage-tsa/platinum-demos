...
| **Action** &nbsp; 0.1.1 | From sidebar menu, click the **Applications** icon and choose **RobotShop**. <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-watson-aiops-observability/images/applications-robotshop.png" width="800" /> |
