...
| **Action** &nbsp; 0.1.1 | From the sidebar menu, click the **Applications** icon (1) and choose **Robot Shop** (2). <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-watson-aiops-observability/images/applications-robotshop.png" width="800" /> |
...
| **Action** &nbsp; 0.2.1 | Hover the cursor over a few of the icons to show info on what technology they are built on. <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-watson-aiops-observability/images/hover-icons.png" width="800" /> |
