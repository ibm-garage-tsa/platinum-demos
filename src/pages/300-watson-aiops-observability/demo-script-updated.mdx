...
| **Action** | From sidebar menu, click on **Applications** icon and choose **RobotShop**. <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-watson-aiops-observability/images/applications-robotshop.png" width="800" /> |
| **Action** | Click the **Dependencies** tab. <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-watson-aiops-observability/images/robot_shop_starting_point.png" width="800" /> |
...
| **Action** | Hover over a few of the icons to show info on what technology they are built on. <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-watson-aiops-observability/images/robot_shop_starting_point.png" width="800" /> |
...
| **Action 3.1.1** | Under **Related Events**, click on the event that says **Sudden increase in the number of erroneous calls**.<br/><br/>Then, click **Analyze Calls**. <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-watson-aiops-observability/images/events.png" width="800" /> |
...
| **Action 3.2.1** | Click on the endpoint named **CONNECT**.<br/><br/> Then, click on the first call (also named **CONNECT**). <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-watson-aiops-observability/images/endpoint_connect.png" width="800" /> |
