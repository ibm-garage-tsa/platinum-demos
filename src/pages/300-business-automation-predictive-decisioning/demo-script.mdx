...
<summary>1 - Present the retention policy before using Cloud Pak for Business Automation</summary>
<br/>
...
<summary>3 - Detail the customer retention business decisions in Automation Decision Services</summary>
<br/>
...
<summary>4 - Show the call center application with Cloud Pak for Business Automation</summary>
<br/>
