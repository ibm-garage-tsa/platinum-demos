...
<summary>1 - Present the retention policy before using IBM Cloud Pak for Business Automation</summary>
<br/>
...
<summary>4 - Show the call center application with IBM Cloud Pak for Business Automation</summary>
<br/>
