...
| **Screenshot** | <br/> ![Finding root cause](./images/affected-display.png) |
| **DUPE** | <br/> ![Finding root cause](./images/finding-root-cause.png) |
...
| **Screenshot** | <br/> ![Components](./images/components.png) |
...
| **Screenshots** | <br/> ![Preview logs](./images/preview-logs
.png) <br/> ![Log preview](./images/log-preview.png) |
