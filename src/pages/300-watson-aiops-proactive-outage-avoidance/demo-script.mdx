...
| **Action** &nbsp; 3.1.4 | Click **Preview Logs** of **Pattern 1**. <br/><br/> <InlineNotification><strong>NOTE</strong>: <strong>Pattern 1</strong> displays '<strong>Unknown pattern. Error message in the pattern</strong>.'</InlineNotification> <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-watson-aiops-proactive-outage-avoidance/images/Fig-3-1-4.png" width="400" /> |
