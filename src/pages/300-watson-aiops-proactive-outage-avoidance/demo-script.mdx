...
(Demo intro slides [here](./watson-aiops-proactive-outage-avoidance.pptx))
...
| **Action** &nbsp; 2.1.1 | Navigate to the tab running **Slack** and examine the incoming story. <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-watson-aiops-proactive-outage-avoidance/images/story.png" width="600" /> |
...
| **Action** &nbsp; 4.1.9 | Click **Run** to start the execution of the runbook. <br/><br/> <InlineNotification><strong>NOTE</strong>: Do <strong>NOT</strong> click <strong>Complete</strong> yet. That will take place later.</InlineNotification> <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-watson-aiops-proactive-outage-avoidance/images/run-runbook.png" width="800" /> |
...
| **Action** &nbsp; 4.1.10 | Navigate to the **Instana** tab. Validate that there are improvements in the erroneous call rate and latency. <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-watson-aiops-proactive-outage-avoidance/images/metric-improvements.png" width="800" /> |
