...
### **WARNING**: October 12, 2022. Due to issues with the required Center of Competency infrastructure, this demo is currently unavailable. We will provide daily updates until this issue is resolved.
...
| **Action** &nbsp; 3.1.6 | In the **View alerts** pop-up window, select **Alerts** from the drop-down menu options. <br/><br/><InlineNotification><strong>NOTE</strong>: You may need to wait a few minutes for <strong>Alerts</strong> to appear.</InlineNotification> <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-watson-aiops-proactive-outage-avoidance/images/alerts.png" width="400" /> |
...
| **Action** &nbsp; 4.1.4 | In the **Alerts** tab, select the first alert in the list that confirms a critical alert in the **qotd-rating** service. <br/><br/><InlineNotification><strong>NOTE</strong>: Make sure to pick the first alert that is <strong>NOT</strong> in the <strong>Closed</strong> state.</InlineNotification> <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-watson-aiops-proactive-outage-avoidance/images/first-alert.png" width="600" /> |
