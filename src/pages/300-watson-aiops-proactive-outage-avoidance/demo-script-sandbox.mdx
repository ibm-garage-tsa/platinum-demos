...
| **Action** &nbsp; 4.1.7 | Navigate back to the **Overview** tab to execute the recommended runbook. In the **Recommended runbooks** section, click the **pop-up menu** (1) and then **Run** (2). <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-watson-aiops-proactive-outage-avoidance/images/Fig-4-1-7.png" width="600" /> |
| **Action** &nbsp; 4.1.8 | Click **Start runbook**. <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-watson-aiops-proactive-outage-avoidance/images/Fig-4-1-8.png" width="800" /> |
