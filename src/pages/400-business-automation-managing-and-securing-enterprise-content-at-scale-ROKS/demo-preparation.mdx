...
2. Use the URL from your cheat sheet to open IBM Content Navigator in a browser tab. Log in using the ‘cp4admin’ username and password from your cheat sheet.
...
## **PREPARE TO GIVE THIS DEMO AGAIN**

<details>

<summary>Recreate a finalized Teamspace</summary>
