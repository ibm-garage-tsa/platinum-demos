...
| **Demo downloads** | • <a href="https://ibm.box.com/s/z753aa8dr9p572etwvjs82y3jbj22lak" target="_blank" rel="noreferrer">Demo installer archive</a><br/> • <a href="./Resource files.zip" target="_blank" rel="noreferrer">Resource files.zip</a><br/> |
| **Required versions** | Cloud Pak for Business Automation V22.0.1<br/><br/> This documentation only works with the ECM demo installer v3 |
...
3.	Copy the Admin **token** (1) and the Admin **server** URL (2) to your cheat sheet.<br/><br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/400-business-automation-managing-and-securing-enterprise-content-at-scale-ROKS/images/Prep360.png" width="800" /><br/>

4.	Close the tab in your browser to return to the ROKS admin page.<br/><br/>

Let's get the URL and password to access Business Automation Studio.<br/><br/>
...
6. Replace the **ocpAdminURL** tag with the 'Admin server' URL on your cheat sheet (see step 2-3).<br/><br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/400-business-automation-managing-and-securing-enterprise-content-at-scale-ROKS/images/Prep365.png" width="800" /><br/>

7. Replace the **ocpAdminToken** tag with the 'Admin token' on your cheat sheet (see step 2-3).<br/><br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/400-business-automation-managing-and-securing-enterprise-content-at-scale-ROKS/images/Prep366.png" width="800" /><br/>
...
1. Open IBM Content Navigator using the URL from your cheat sheet. Select **Enterprise LDAP** in the **Log in with** drop down menu (1). Enter the **‘cp4admin’ Username** and the **Password** (2) from your cheat sheet. Click **Log in** (3).<br/><br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/400-business-automation-managing-and-securing-enterprise-content-at-scale-ROKS/images/Prep52.png" width="800" /><br/>
