...
4.	Close the tab in your browser to return to the ROKS admin page.<br/>
...
3. Open the folder containing the HR and John Doe document repositories so that it is available during the entire demo.
...
<InlineNotification>Do not log into these capabilities now, you will do this during the demonstration.</InlineNotification>
