...
8.	Copy the admin_password and admin_username to your cheat sheet.<br/><br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/400-business-automation-managing-and-securing-enterprise-content-at-scale-ROKS/images/Prep40.png" width="800" /><br/><InlineNotification> These logins are not the same as the ‘cp4admin’ credentials copied for CP4BA capabilities earlier in Step 2.</InlineNotification><br/>
...
A script will help you configure the IBM FileNet Content Manager and IBM Cloud Pak for automation in just one click. Only IBM Content Navigator configuration will be manual.

This automated configuration script uses the FNCM and CP4BA public APIs to:

<br/>

1.	Create in the platform the three personas used in this scenario: Henry (the HR Manager), Debby (the hiring Manager), and Patrick (the payroll Manager). Let’s configure the individual accounts for Henry, Debby, and Patrick.
2.	Create the document data model in FileNet Content Manager
...
6. Change the **ocpAdminURL** tag with the AdminURL stored in your cheat sheet (See 2.3).<br/><br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/400-business-automation-managing-and-securing-enterprise-content-at-scale-ROKS/images/Prep365.png" width="800" /><br/>

7. Change the **ocpAdminToken** tag with the Admin token stored in your cheat sheet (See 2.3).<br/><br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/400-business-automation-managing-and-securing-enterprise-content-at-scale-ROKS/images/Prep366.png" width="800" /><br/>
...
11. Wait around 3-4 minutes for the execution to complete.<br/>
...
<InlineNotification> Review the entire display to check that all actions are successful (meaning none failed or were skipped).</InlineNotification><br/>
...
11. Make sure the Administration settings menu displays as an option for henry to select.<br/><br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/400-business-automation-managing-and-securing-enterprise-content-at-scale-ROKS/images/Prep61.png" width="800" /><br/></br/>**If ‘Administration’ does not appear, go back to step WHICH STEP? and repeat the steps.**<br/>
...
13. Refresh your browser window.<br/><br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/400-business-automation-managing-and-securing-enterprise-content-at-scale-ROKS/images/Prep116.png" width="800" /><br/>
 
<br/>
...
34.	Check that your **Private Information** redaction reason is linked to the **content** object store.<br/><br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/400-business-automation-managing-and-securing-enterprise-content-at-scale-ROKS/images/Prep184.png" width="800" /><br/>
...
1. Refresh your browser ot open IBM Content Navigator using the URL from your cheat sheet. Log in using the username ‘cp4admin’ and password from your cheat sheet.
...
35. Logout from Content Navigator.<br/>
