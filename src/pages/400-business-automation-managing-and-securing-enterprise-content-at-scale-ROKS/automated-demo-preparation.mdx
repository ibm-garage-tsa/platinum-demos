...
You can download these documents <a href="<a href="./Resource files.zip" target="_blank" rel="noreferrer">here</a><br/>.
...
35. Logout of IBM Content Navigator.<br/><br/>
...
5. Open the folder containing the HR and John Doe’s document repositories so that it is available during the entire demo.
