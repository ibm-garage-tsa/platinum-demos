...
A script will help you configure the IBM FileNet Content Manager (FNCM) and IBM Cloud Pak for automation in just one click. Only IBM Content Navigator configuration will be manual.
