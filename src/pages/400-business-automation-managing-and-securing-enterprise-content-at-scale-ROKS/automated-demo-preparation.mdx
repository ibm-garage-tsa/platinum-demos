...
<InlineNotification> These logins are not the same as the ‘cp4admin’ credentials copied for CP4BA capabilities earlier in Step 2.</InlineNotification><br/>
...
Let's get the URL and passwords to access each capability.<br/><br/>
...
1. Pre-requisite: Ensure you have Java8 or later installed on your computer. (type java -version in a shell window(1) and check the version (2)).<br/><br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/400-business-automation-managing-and-securing-enterprise-content-at-scale-ROKS/images/Prep361.png" width="800" /><br/>

2. Unzip the installer archive on your computer.<br/><br/> 
...
9. On MAC: type ‘chmod 755 configureContentPlatinumDemoStarter.sh’ tom make the file  executable. <br/><br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/400-business-automation-managing-and-securing-enterprise-content-at-scale-ROKS/images/Prep368.png" width="800" /><br/>
