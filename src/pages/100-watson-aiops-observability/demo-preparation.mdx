...
| **Before the demo** | **Environment setup** <br/> •	Log into https://ibmdemo-instanaibm.instana.io. <br/> •	Set the time period to show an active incident, as detailed below: <br/> <br/> 1.	In the upper right, click the button showing the timeframe. <br/> [timeframe](./images/timeframe.png" width="400") <br/> 2.	At the bottom of the pop-up, set the timeframe so that it begins at 25 minutes past the hour and ends at 35 minutes past the hour. It doesn’t matter which hour you pick. Click **‘set time’**. <br/> Note: Pressing 'enter' doesn’t work. You'll need to actually click the button. <br/> This will ensure you see normal behavior and then a sudden change when the incident begins at 0:30. <br/> [time_range](./images/time_range.png" width="600") <br/> 3.	Check that the summary tab for the robot shop (**Applications** -> **Robot Shop** -> **Summary**) looks like this (seeing drop in call volume and spikes in errors and latency). <br/> [robot_shop_summary](./images/robot_shop_summary.png" width="800") <br/> 4.	Click on **Events** on the sidebar menu and check that there are open incidents, including 'sudden increase in the number of erroneous calls' on the 'discount' service. <br/> [open_incidents](./images/open_incidents.png" width="600") <br/> <br/> **Requisition instructions** <br/> Please see [below](#place1). |
