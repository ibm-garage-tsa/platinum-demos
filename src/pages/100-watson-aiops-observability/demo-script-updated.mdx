...
| **Action** | From sidebar menu, click **Applications**. Choose **Robot Shop.** Click the **Dependencies** tab. <br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-watson-aiops-observability/images/robot_shop_starting_point.png" width="800" /> |
