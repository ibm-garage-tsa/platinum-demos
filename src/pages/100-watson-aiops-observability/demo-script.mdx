...
![banner](./images/AIOPS_Observability_100_Script_GitHub_banner_7-30-21.jpg)
...
| **Narration**             | Now that MySQL is working again, we can go back and confirm that the problems with Robot Shop have been repaired. |
