...
| **Action** &nbsp; 1.1.4 | The anomaly generator will take a minute or so to start showing alerts in Slack. While it is running, navigate to Prometheus. <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-watson-aiops-proactive-incident-resolution/images/prometheus.png" width="800" /> |
| **Action** &nbsp; 1.1.5 | Then, navigate to ELK. <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-watson-aiops-proactive-incident-resolution/images/elastic.png" width="800" /> |
