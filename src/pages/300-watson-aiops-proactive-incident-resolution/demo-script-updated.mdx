...
| **Action** &nbsp; 1.1.4 | The anomaly generator will take a minute or so to start showing alerts in Slack.<br/><br/> While it is running, navigate to Prometheus. <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-watson-aiops-proactive-incident-resolution/images/prometheus.png" width="800" /> |
| **Action** &nbsp; 1.1.5 | Navigate to ELK. <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-watson-aiops-proactive-incident-resolution/images/elastic.png" width="800" /> |
...
| **Action** &nbsp; 5.1.2 | Click **Events** in the sidebar menu. The top event should show a red circle (**critical**). Click the **Down** arrow to expand it. <br/><br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-watson-aiops-proactive-incident-resolution/images/events2.png" width="800" /> |
...
| **Action** &nbsp; 5.1.3 | Click the second row to select it (**Summary** column: **Rating service Mem usage very high**). Click **Execute runbook**.<br/><br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-watson-aiops-proactive-incident-resolution/images/events3.png" width="800" /> |
| **Action** &nbsp; 5.1.4 | Click **Start runbook**. <br/> <br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-watson-aiops-proactive-incident-resolution/images/runbook1.png" width="800" /> |
| **Action** &nbsp; 5.1.5 | Click **Run**. <br/><br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-watson-aiops-proactive-incident-resolution/images/runbook2.png" width="800" /> |
| **Action** &nbsp; 5.1.6 | Click on the second row to select it (**Summary** column: **Rating service Mem usage very high**). |
| **Action** &nbsp; 5.1.7 | Click **Execute runbook**.<br/><br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-watson-aiops-proactive-incident-resolution/images/events3.png" width="800" /> |
| **Action** &nbsp; 5.1.8 | Click on **Start runbook**. <br/> <br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-watson-aiops-proactive-incident-resolution/images/runbook1.png" width="800" /> |
| **Action** &nbsp; 5.1.9 | Click on **Run**. <br/><br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-watson-aiops-proactive-incident-resolution/images/runbook2.png" width="800" /> |
| Stashed changes | ************* |
...
| **Action** &nbsp; 6.1.1 | Go back to the **Runbook** screen. <br/><br/> **Note:** If you navigated away from it, go back with these steps: <br/><br/> **Automations** -> **Runbooks** -> click the three dots at the far right for the **Reset Rating Service** runbook -> Choose **View history** -> Click **Resume on most recent**. |
