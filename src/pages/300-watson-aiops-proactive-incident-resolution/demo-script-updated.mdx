...
| **Action 1.1.1** | Navigate to the **Anomaly Generator**. |
...
| **Action 1.1.4** | The anomaly generator will take a minute or so to start showing alerts in Slack.<br/><br/> While it is running, navigate to the various input sources: Prometheus and ELK. <br/><br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-watson-aiops-proactive-incident-resolution/images/prometheus.png" width="800" /> <br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-watson-aiops-proactive-incident-resolution/images/elastic.png" width="800" /> |
...
| **Action 2.1.1** | Story starts showing up in Slack. <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-watson-aiops-proactive-incident-resolution/images/incident-title.png" width="800" /> |
...
| **Action 3.1.2** | Click on the **View relevant events** button at the bottom of the notification.<br/><br/>A pop-up will appear with the grouped events. <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-watson-aiops-proactive-incident-resolution/images/view-relevant-events.png" width="800" /> <br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-watson-aiops-proactive-incident-resolution/images/relevant-events-alerts.png" width="800" /> |
...
| **Action 3.1.3** | Scroll down past the alerts to show **Log anomaly**. <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-watson-aiops-proactive-incident-resolution/images/rating-service.png" width="800" /> |
...
| **Action 3.1.4** | Click on **Show more**. <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-watson-aiops-proactive-incident-resolution/images/anomaly.png" width="800" /> <br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-watson-aiops-proactive-incident-resolution/images/log-anomaly-1.png" width="500" /> |
| **Narration** | We can preview the log messages that caused Watson AIOps to find the anomaly. |
| **Action 3.1.5** | For the 'Unknown_error' anomaly, click on **Preview logs**. <br/> <br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-watson-aiops-proactive-incident-resolution/images/preview-logs.png" width="500" /> <br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-watson-aiops-proactive-incident-resolution/images/log-preview.png" width="500" /> |
...
| **Action 4.1.2** | Click on the **Search similar incidents** button.<br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-watson-aiops-proactive-incident-resolution/images/search-similar-incidents.png" width="800" />
...
| **Action 4.1.5** | Click on the link for the first similar incident **Rating service overheating and slowing**. It will open a window in GitLab.<br/><br/>If needed, sort comments **newest first**. <br/><br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-watson-aiops-proactive-incident-resolution/images/newest-first.png" width="800" /> |
...
| **Action 5.1.1** | Navigate to **Event Manager** (formally known as NOI). |
| **Action 5.1.2** | Click **Events** in the sidebar menu. The top event should show a red circle (**critical**). <br/><br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-watson-aiops-proactive-incident-resolution/images/events2.png" width="800" /> |
| **Action 5.1.3** | Click the **Down** arrow to expand it. |
...
| **Action 5.1.4** | Click on the second row to select it (**Summary** column: **Rating service Mem usage very high**). |
| **Action 5.1.5** | Click **Execute runbook**<br/><br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-watson-aiops-proactive-incident-resolution/images/events3.png" width="800" /> |
| **Action 5.1.6** | Click on **Start runbook**. <br/> <br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-watson-aiops-proactive-incident-resolution/images/runbook1.png" width="800" /> |
| **Action 5.1.7** | Click on **Run**. <br/><br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-watson-aiops-proactive-incident-resolution/images/runbook2.png" width="800" /> |
...
| **Action 5.1.8** | Navigate to **Instana**. (see image for **Action 5.1.10**, below) |
| **Action 5.1.9** | Click on the **Summary** tab. (see image for **Action 5.1.10**, below) |
| **Action 5.1.10** | Set the time period to **last 15 minutes**, and click on the **Live** button (you will be showing the latency before, during, and after the incident). <br/><br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-watson-aiops-proactive-incident-resolution/images/runbook-success.png" width="800" /> |
...
| **Action 6.1.1** | Go back to the Runbook screen.<br/><br/>**Note:** If you navigated away from it, go back with these steps:<br/><br/>Automations -> Runbooks -> click on the three dots at the far right for the **Reset Rating Service** runbook -> Choose **View history** -> Click **Resume on most recent**. |
| **Action 6.1.2** | Scroll down to the bottom where there are stars/ratings. <br/><br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-watson-aiops-proactive-incident-resolution/images/runbook-worked.png" width="800" /> |
...
| **Action 6.1.3** | Navigate to **Slack**. |
| **Action 6.1.4** | Add details about the resolution by clicking the **Add to story** button. <br/><br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-watson-aiops-proactive-incident-resolution/images/search-results-story-695.png" width="800" /> |
...
| **Action 6.1.5** | At the bottom of the story notification, click **Acknowledge**. <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-watson-aiops-proactive-incident-resolution/images/acknowledge.png" width="800" /> |
| **Action 6.1.6** | Choose **Keep in current channel** and **Closed**.<br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-watson-aiops-proactive-incident-resolution/images/closed.png" width="800" /> |
| **Action 6.1.7** | Optionally add a comment, such as 'Executed runbook to fix issue,' and then click  **Acknowledge**. |
