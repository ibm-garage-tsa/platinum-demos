...
| **Action** &nbsp; 3.1.3 | Observe that a pop-up will appear with the grouped events. <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-watson-aiops-proactive-incident-resolution/images/relevant-events-alerts.png" width="800" /> |
...
| **Action** &nbsp; 3.1.8 | You will see the **Log preview**. <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-watson-aiops-proactive-incident-resolution/images/log-preview.png" width="500" /> |
...
| **Action** &nbsp; 4.1.5 | Click the link for the first similar incident **Rating service overheating and slowing**. It will open a window in GitLab.<br/><br/>If needed, sort comments **newest first**. <br/><br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-watson-aiops-proactive-incident-resolution/images/newest-first.png" width="800" /> |
...
| **Action** &nbsp; 5.1.4 | Click the second row to select it (**Summary** column: **Rating service Mem usage very high**). |
...
| **Action** &nbsp; 5.1.6 | Click **Start runbook**. <br/> <br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-watson-aiops-proactive-incident-resolution/images/runbook1.png" width="800" /> |
| **Action** &nbsp; 5.1.7 | Click **Run**. <br/><br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-watson-aiops-proactive-incident-resolution/images/runbook2.png" width="800" /> |
