...
| **Action** &nbsp; 3.1.3 | In the **View alerts** pop-up window, scroll past the alerts to the **Log Anomaly** section. <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-watson-aiops-proactive-incident-resolution/images/8-View-Alerts-(1647712825725)-A.png" width="600" /> |
...
| **Action** &nbsp; 5.2.2 | Click the **circle** under the **Runbook** column of the fourth row, in which the **Summary** column reads, '**Rating service response time over past minute is significantly high (> 1.0s)**' (1). Then, click **Execute runbook** (2). <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-watson-aiops-proactive-incident-resolution/images/23-image-.png" width="800" /> |
