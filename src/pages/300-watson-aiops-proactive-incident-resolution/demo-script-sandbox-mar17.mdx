...
| **1.1** | **Examine Quote of the Day's baseline healthy behavior** |
| :--- | :--- |
| **Narration** | [Instana summary tab] <br/><br/> [Placeholder for number of calls, erroneous calls, mean latency, processing time] |
| **Action** &nbsp; 1.1.1 | Navigate to **Instana**, and click the **Summary** tab. Set the time period to **last 5 minutes**, and click the **Live** button. <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-watson-aiops-proactive-incident-resolution/images/1.png" width="800" /> |
...
| **Action** &nbsp; 4.1.1 | Click the **Search similar incidents** button. <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-watson-aiops-proactive-incident-resolution/images/search-similar-incidents.png" width="800" />
...
| **5.1** | **Understand topological relationships to better assess the scope of issues** |
| :--- | :--- |
...
| **Action** &nbsp; 6.1.1 | Go back to the **Runbook** screen on the **Event Manager** tab. <br/><br/> **Note:** If you navigated away from it, go back with these steps: <br/><br/> **Automations** -> **Runbooks** -> Click the three dots at the far right for the **Reset Rating Service** runbook -> Choose **View history** -> Click **Resume on most recent**. <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-watson-aiops-proactive-incident-resolution/images/6.1.1.png" width="800" /> |
