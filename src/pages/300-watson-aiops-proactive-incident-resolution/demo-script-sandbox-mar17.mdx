...
| :--- | :--- |
| **Narration** | [Placeholder for number of calls, erroneous calls, mean latency, processing time] |
...
| **Action** &nbsp; 1.2.1 | From the **Sabine Cluster Details** page, click the **Quote of the Day Anomaly Generator** link to launch the anomaly generator web application. <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-watson-aiops-proactive-incident-resolution/images/Credentials.png" width="400" /> |
| **Action** &nbsp; 1.2.2 | Choose **Rating service failure**. <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-watson-aiops-proactive-incident-resolution/images/quote-app.png" width="800" /> |
| **Action** &nbsp; 1.2.3 | Click **Start**. <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-watson-aiops-proactive-incident-resolution/images/1.1.3.png" width="800" /> |
...
| **Action** &nbsp; 1.2.4 | The anomaly generator will take a minute or so to start showing alerts in Slack. While it is running, navigate to your **Prometheus** tab (you should already have this open from the demo preparation). <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-watson-aiops-proactive-incident-resolution/images/prometheus.png" width="800" /> |
| **Action** &nbsp; 1.2.5 | Then, navigate to the **ELK** tab (you should already have this open from the demo preparation). <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-watson-aiops-proactive-incident-resolution/images/elastic.png" width="800" /> |
...
| **Action** &nbsp; 3.1.8 | The **Log preview** pop-up will appear. <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-watson-aiops-proactive-incident-resolution/images/log-preview.png" width="500" /> |
| **Action** &nbsp; 3.1.9 | Close the **Log preview** pop-up. <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-watson-aiops-proactive-incident-resolution/images/4.1.1.png" width="400" /> |
...
| **Action** &nbsp; 4.1.2 | Type **rating** into the search box. <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-watson-aiops-proactive-incident-resolution/images/search-similar-incidents-rating.png" width="400" />
...
| **Action** &nbsp; 4.1.3 | Review the  **Search results** window. <br/><br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-watson-aiops-proactive-incident-resolution/images/search-results.png" width="400" /> |
...
| **Action** &nbsp; 5.1.1 | Navigate to the **Event Manager** tab (you should already have this open from the demo preparation). Click **Events** on the sidebar menu. The top event should show a red circle (**critical**). Click the **Down** arrow to expand it. <br/><br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-watson-aiops-proactive-incident-resolution/images/events2.png" width="800" /> |
