...
You’ll see how Watson AIOps helps you: <br/>
•	Intelligently correlate multiple disparate sources of information, such as logs, metrics, events, tickets, and topology <br/>
•	Condense and present all of this information in actionable alerts instead of large quantities of unrelated alerts <br/>
•	Resolve problems within seconds to minutes of being notified using Watson AIOps’ automation capabilities <br/>
...
| **Action** &nbsp; 1.2.1 | Select the **Quote of the Day Anomaly Inducer** tab. Click **Ratings service failures**. <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-watson-aiops-proactive-incident-resolution/images/2-Anomaly-Gen-Home-Page-.png" width="600" /> |
...
| **Action** &nbsp; 3.1.3 | In the **View alerts** pop-up window, scroll to the **Log Anomaly** section. <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-watson-aiops-proactive-incident-resolution/images/8-View-Alerts-(1647712825725)-A.png" width="600" /> |
