...
| **Action** &nbsp; 5.1.2 | Point out the relationships, particularly the relationship between the nodes marked red: **qotd-web** and **qotd-rating**. <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-watson-aiops-proactive-incident-resolution/images/18-topology-1-C.png" width="800" /> |
| **Action** &nbsp; 5.1.3 | Click the **Hierarchy** icon (1), located on the right side, to change the topology orientation to an **Inverted tree** (2). <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-watson-aiops-proactive-incident-resolution/images/32-.png" width="300" /> |
