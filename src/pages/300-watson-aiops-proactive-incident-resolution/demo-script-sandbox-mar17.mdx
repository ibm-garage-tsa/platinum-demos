...
| :--- | :--- |
| **Action** &nbsp; 6.2.1 | Navigate to the **Slack** tab, and click **Mark as resolved**. <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-watson-aiops-proactive-incident-resolution/images/27-mark-as-resolved-.png" width="600" /> |
