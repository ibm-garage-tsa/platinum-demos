...
1. Open a browser window, then paste and go to the Github URL to the cp4i-deployment-samples folder that you copied in section 3 (Fork the GitHub repository), step 5 of this preparation.
