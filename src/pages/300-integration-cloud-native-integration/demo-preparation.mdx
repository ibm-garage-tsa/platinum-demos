...
<br/><br/><InlineNotification><strong>NOTE</strong> If there are no clusters availabile in Express installation, go ahead with the Custom installation. While the process is the same, Express is a 5 minute request (because you will receive a pre-created ROKS cluster from a queue), and custom is a 2 hour provisioning (because the ROKS cluster will be installed, behind the scenes, from scratch for you).</InlineNotification><br/>
...
1. Click <a href="https://cloud.ibm.com/catalog/content/ibm-cp-integration-72f63273-f2f6-4e9c-8626-60fe798c57be-global" target="_blank" rel="noreferrer">here</a> to install Cloud Pak for Integration. This link takes you to an IBM Cloud page. Log in with your personal IBM credentials. <br/><br/>Confirm you are using the **ITZ** account using the box in the upper right-hand corner of the intallation configuration page.
...
5. Scroll down to the **Set the deployment values** section. Toggle the **Use an existing secret?** option to **no** and define a new password. The new password needs to be 32-characters, using only letters and numbers. You will need this password in step 12.<br/><InlineNotification><strong>NOTE</strong>: Currently, password validation is not enforced on this page. If you proceed with an invalid password you will be able to start the installation, but it will fail when you try to use it later. There is no way to recover from this error other than provisioning a new cluster.</InlineNotification>
...
9. When the status is **Active**, you will be able to access Cloud Pak for Integration Platform Navigator. Select **Offering Dashboard** on the upper right corner of the page.<br/><InlineNotification><strong>NOTE</strong>: Copy and save the URL after you click <strong>Offering Dashboard</strong>. This is your CP4I URL and will be required in step 1 of the demo script.</InlineNotification><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration/images/offering_dashboard.png" width="800" />
...
12. From the **Home Page**, open the top left menu (1) and then click **Integration instances** (2) under **Administration**.
<br/><br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-cloud-native-integration/images/image1.2.1.png" width="800" />

<br/>

13. The Cloud Pak for Integration capabilities are displayed in the type column.
<br/><br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-cloud-native-integration/images/prep-image1.13.png" width="800" /><br/>
...
<br/><br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-cloud-native-integration/images/prepare-1-1.png" width="800" /><br/>
...
3. Click **Fork**. 
<br/><br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-cloud-native-integration/images/prepare-1-3.png" width="800" /><br/>

4. Verify that you are using **Owner** (1) you intended. Click **Create fork** (2).
<br/><br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-cloud-native-integration/images/prep-image3-4.png" width="800" /><br/>
...
1. On the forked repo, click **Code** (1). Click the icon to copy the URL (2).
<br/><br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-cloud-native-integration/images/prepare-2-1.png" width="800" /><br/>
...
<br/><br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-cloud-native-integration/images/prepare-3-2.png" width="800" />
<br/>

3. Click **Open your Managed OpenShift (ROKS) environment**.
<br/><br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-cloud-native-integration/images/prepare-3-3.png" width="800" />
<br/>

4. Click **OpenShift web console**.<br/><br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-cloud-native-integration/images/prepare-3-4.png" width="800" />

<br/>

5. On the web console page, click **?** (1), and select **Command line tools** (2). 
<br/><br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-cloud-native-integration/images/prepare-3-5.png" width="800" />

<br/>

6. Follow the links to install the **OpenShift Command Line Interface** (CLI) for your Operating System. 
<br/><br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-cloud-native-integration/images/prepare-3-6.png" width="800" />
...
1. Log into your OpenShift cluster using CLI. From the dropdown menu in the upper right of the page, under your **username** (1), click **Copy login command** (2).
<br/><br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-cloud-native-integration/images/prepare-4-1.png" width="800" />

<br/>

2. Click **Display Token**.
<br/><br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-cloud-native-integration/images/prepare-4-2.png" width="800" />

<br/>

3. Copy the **login** command.
<br/><br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-cloud-native-integration/images/prepare-4-3.png" width="800" />

<br/>

4. Open your terminal window and paste the **login command** to access your OpenShift cluster.
<br/><br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-cloud-native-integration/images/prepare-4-4.png" width="500" />
...
3. Set the GitHub repository to use as the URL of your forked repository (made in section 3).
<br/><br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-cloud-native-integration/images/prepare-5-3-1.png" width="800" /><br/>
...
1. In the **cp4i-deployment-samples** folder, open the **DrivewayDentDeletion/Operators folder**.<br/><br/><code>cd DrivewayDentDeletion/Operators</code>
<br/><br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-cloud-native-integration/images/prepare-6-1.png" width="800" /><br/>

2. Create the pipeline by running this command.<br/><br/><code>./cicd-apply-test-apic-pipeline.sh -n $NAMESPACE -r $FORKED_REPO -b $BRANCH</code>
<br/><br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-cloud-native-integration/images/prepare-6-2.png" width="800" /><br/>

3. In the terminal output, scrool to find the **Webhook route** URL. Copy and save the URL, as shown in this screenshot. It will be require to complete step 4.1.4 of the demo.
<br/><br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-cloud-native-integration/images/newprep8.3.png" width="800" /><br/>

4. Return to the OpenShift console. On the left menu, open **Pipelines**, then **Pipelines** to see what has been added.
<br/><br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-cloud-native-integration/images/prepare-6-3.png" width="800" /><br/>

5. On the **Project combo box** (1), select **cp4i** (2).
<br/><br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-cloud-native-integration/images/prepare-6-4.png" width="800" /><br/>

6. Validate that there are two pipelines.
<br/><br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-cloud-native-integration/images/prepare-6-5.png" width="800" /><br/>
...
<br/><br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-cloud-native-integration/images/prepare-7-2.png" width="800" /><br/>
...
1. Open a browser window, then paste and go to the CP4I URL you copied and saved from section **2.9 (Install Cloud Pak for Integration on ROKS cluster)** above.
...
1. Open <a href="https://techzone.ibm.com/my/reservations">My reservations</a>.
...
Click [here](/300-integration-cloud-native-integration/demo-script) to go to the **Demo script** on the next tab. (actual PDF to be produced when demo and script are approved)
