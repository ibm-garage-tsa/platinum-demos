...
| **Required versions** | Cloud Pak for Integration 2023.2 |
...
10. When the status updates to **Active** (1), you will be able to access Cloud Pak for Integration Platform Navigator. Click **Offering Dashboard** (2).<br/><br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-api-enabled-application-integration/images/Prep2.10.png" width="800" /><br/><InlineNotification>If your install fails, you must go to your <a href="https://techzone.ibm.com/my/reservations" target="_blank" rel="noreferrer">My reservations</a> page, delete your environment, and start again from step <strong>1 - Provision a Cloud Pak for Integration environment</strong>.</InlineNotification><br/>

11. Save the Offering Dashboard URL. This is the Cloud Pak for Integration URL for this demo.

<br/>

12. On the log in page, select the authentication type **IBM provided credentials (admin only)**.<br/><br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-cloud-native-integration/images/authentication-types.png" width="800" /><br/>

13. Log in using the Username **“admin”** and the 32-character password that you created previously in step 5.<br/><br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-cloud-native-integration/images/login.png" width="800" /><br/>

14. Click **Integration instances**.<br/><br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-cloud-native-integration/images/integration-instances.png" width="800" /><br/>

15. The parts of the Cloud Pak (API Connect, App Connect Designer, App Connect Dashboard and Asset Repository) will display here. Additional instances for any of the integration capabilities can be created by selecting **Create an instance**.<br/><br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-cloud-native-integration/images/instances.png" width="800" /><br/>

You have successfully completed cluster provisioning, installation of Cloud Pak for Integration, and deployment of API Connect and App Connect. You are ready to proceed.<br/><br/>
