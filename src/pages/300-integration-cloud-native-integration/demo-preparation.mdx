...
| **Demo intro slides** | Download the Introduction and Overview slides [here](./integration-cloud-native-integration-deployment.pptx). This is a short deck of customer-facing slides that sets the context for the demo. |
...
1. To reserve a preinstalled Cloud Pak for Integration (CP4I) ROKS 4.6 cluster on Red Hat OpenShift, go <a href="https://techzone.ibm.com/my/reservations/create/611bf99bd21122001e42d3fc" target="_blank" rel="noreferrer">here</a> and complete the form. If you do not have a sales opportunity, select the purpose **Practice / Self-Education**.
...
3. In approximately 30 minutes, you will receive a second email indicating the environment is provisioned. This email includes environment access information. <br/><br/>You are now ready to install Cloud Pak for Integration.<br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-cloud-native-integration/images/prep-image1.3.png" width="800" /><br/>
...
15. The parts of the Cloud Pak (API Connect, App Connect Designer, App Connect Dashboard and Asset Repository) will display here. Additional instances for any of the integration capabilities can be created by selecting **Create capability**.
...
1. Open the **cp4i-deployment-samples folder**.<br/><br/><code>cd p4i-deployment-samples</code>, then open the **DrivewayDentDeletion/Operators folder**.<br/><br/><code>cd DrivewayDentDeletion/Operators</code><br/><img src="./images/prepare-6-1.png" width="800" /><br/>
