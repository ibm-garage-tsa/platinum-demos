...
9. When the status is **Active**, you will be able to access Cloud Pak for Integration Platform Navigator. Select **Offering Dashboard** on the upper right corner of the page.<br/><InlineNotification><strong>NOTE</strong>: Copy and save the URL after you click <strong>Offering Dashboard</strong>. This is your CP4I URL and will be required in step 1 of the demo script.</InlineNotification><br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration/images/offering_dashboard.png" width="800" />
...
13. The Cloud Pak for Integration capabilities are displayed in the type column.<br/><img src="./images/prep-image1.13.png" width="800" />
...
1. Open a browser window, then paste and go to the OpenShift URL you copied and saved.
...
1. The cp4i-deployment-samples folder was forked the owner specified. Take note of the URL, it is required to complete section 5 of this preparation.
