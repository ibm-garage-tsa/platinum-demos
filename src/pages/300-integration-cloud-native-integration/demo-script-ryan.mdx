...
| **Action** 2.1.1 | Click **Deploy integrations**.<br/><br/><img src="./images/Script2.1.1.png" width="800" /> |
...
| **Action** 2.4.4 | Return to the App Connect Dashboard page. Afther the status indicates **Ready**, click the **simple-echo-app server**. <br/><br/><img src="./images/dent-deletion-2-4-4.png" width="800" /> |
