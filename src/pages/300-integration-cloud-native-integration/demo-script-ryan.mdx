...
| **Action** 1.3.1 | Show the **Integration instances** page, then click **ace-dashboard-demo** in the **Integration dashboard** row.<br/><br/><img src="./images/image1.3.1.png" width="800" /> |
...
| **Action** 2.1.1 | Click **Deploy integrations**.<br/><br/><img src="./images/Prep211.png" width="800" /> |
