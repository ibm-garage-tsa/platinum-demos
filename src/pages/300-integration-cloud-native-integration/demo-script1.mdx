...
| **Action** &nbsp; 1.1.1 | Open Cloud Pak for Integration and click **IBM provided credentials (admin only)**. <br/><br/><img src="./images/dent-deletion-1-1-1.png" width="800" /> |
| **Narration** | Let's log in to a cloud version on IBM Cloud. &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; |
| **Action** &nbsp; 1.1.2 | **Log in** with your admin **username** and **password**.  <br/><br/><img src="./images/dent-deletion-1-1-2.png" width="800" /> |
...
| **Action** &nbsp; 1.2.1 | From the **Home Page**, click **Integration capabilities** (if necessary, close the tour dialog).<br/><br/>If you don't see the Integration instances tile, open the top left menu and select **Administration** and then **Integration instances**. <br/><br/><img src="./images/dent-deletion-1-2-1.png" width="800" /> |
...
| **Action** &nbsp; 1.3.1 | Show the **Integration capabilities** page, then click the **Integration dashboard** (ace-dashboard-demo). <br/><br/><img src="./images/dent-deletion-1-3-1.png" width="800" /><br/> |
...
| **Action** &nbsp; 2.2.1 | Select **Quick start toolkit integration** (1). Click **Next** (2). <br/><br/><img src="./images/dent-deletion-2-2-1.png" width="800" /> |
...
| **Action** &nbsp; 2.4.3 | Open the OpenShift Web Console. On the left menu, select **Workloads**, then **Pods** (1). Select **cp4i** project (2). Show the simple-echo-app pods creation (3). <br/><br/><img src="./images/dent-deletion-2-4-3.png" width="800" /> |
...
| **Action** &nbsp; 3.2.1 | In the OpenShift Web Console, open **Pipelines**, then **Pipelines**. <br/><br/><img src="./images/dent-deletion-3-2-1.png" width="800" /> |
| **Action** &nbsp; 3.2.2 | Filter by **cp4i project**. <br/><br/><img src="./images/dent-deletion-3-2-3.png" width="800" /> |
| **Action** &nbsp; 3.2.3 | Open **test-apic-pipeline**. <br/><br/><img src="./images/dent-deletion-3-2-3.png" width="800" /> |
| **Narration** | As you can see, we specified a pipeline with multiple tasks that build multiple integration images and a queue manager, and also configure some API exposure. The pipeline then deploys these to a test environment, and upon successful completion of tests, deploys into the main environment. |
| **Action** &nbsp; 3.2.4 | Explore **test-apic-pipeline**. <br/><br/><img src="./images/dent-deletion-3-2-4.png" width="800" /> |
...
| **Action** &nbsp; 4.2.2 | Open the pipeline diagram. <br/><br/><img src="./images/dent-deletion-4-2-2.png" width="800" /> |
...
| **Action** &nbsp; 4.2.3 | Explore the pipeline diagram page. <br/><br/><img src="./images/dent-deletion-4-2-3.png" width="800" /> |
...
| **Action** &nbsp; 5.1.1 | Open the App Connect Dashboard server page. <br/><br/><img src="./images/dent-deletion-5-1-1.png" width="800" /> |
...
| :--- | :--- |
| **Narration** | Navigating to API management Portal, we can see the APIs have been deployed into the appropriate products.<br/><br/>Potential partners who want to use the insurance quote aggregators' new aggregation API will be able to come to the portal and self-subscribe to use it.<br/><br/>It’s worth noting that as we navigated between different underlying components we remained in the same user interface, logged in as the same user, and we saw a consistent look and feel to the way each of the components was administered. Furthermore, the navigation and administration capabilities are all governable by a common role-based access control mechanism inherited from the underlying OpenShift platform. |
| **Action** &nbsp; 5.3.1 | Open **Menu** (1). Click **Run** (2), then **API** (3). <br/><br/><img src="./images/dent-deletion-5-3-1.png" width="800" /> |
...
| **Action** &nbsp; 6.1.1 | Open **Menu** (1) and select **Run** (2) > **Integration** (3). <br/><br/><img src="./images/dent-deletion-6-1-1.png" width="800" /> |
