...
| **Narration** | Let's log in to a the Cloud Pak for Integration on IBM Cloud. |
...
| **Action** &nbsp; 1.2.1 | From the **Home Page**, click **Integration capabilities** (if necessary, close the tour dialog).<br/><br/>If you don't see the Integration instances tile, open the top left menu (1) and then click **Integration capabilities** (2) under **Administration**.<br/><br/><img src="./images/dent-deletion-1-2-1.png" width="800" /><br/><br/><img src="./images/image1.2.1.png" width="800" /> |
...
| **Action** &nbsp; 1.3.1 | Show the **Integration capabilities** page, then click **ace-dashboard-demo** in the **Integration dashboard** row. <br/><br/><img src="./images/dent-deletion-1-3-1.png" width="800" /><br/> |
