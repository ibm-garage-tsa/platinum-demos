...
<br/><img src="./images/prepare-1-4.png" width="800" /><br/>
...
<br/><img src="./images/prepare-1-5.png" width="800" /><br/>
...
1. On the forked repo, click **Code** (1) and click **Copy URL button** (2) on the **Clone HTTPS** section.<br/><br/><img src="./images/prepare-2-1.png" width="800" /><br/>
...
1. Log in OpenShift cluster using CLI. From the dropdown menu in the upper right of the page, under your **username** (1), click **Copy login command** (2).<br/>
