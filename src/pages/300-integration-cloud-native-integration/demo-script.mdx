...
| **Action** &nbsp; 1.2.1 | From the **Home Page**, click **Integration capabilities** (if necessary, close the tour dialog).<br/><br/>If you don't see the Integration instances tile, open the top left menu and select **Administration** and then **Integration capabilities**. <br/><br/><img src="./images/dent-deletion-1-2-1.png" width="800" /> |
...
| **Action** &nbsp; 2.4.3 | Open the OpenShift Web console. On the left menu, select **Workloads**, then **Pods** (1). Select the **cp4i** project (2). Show the simple-echo-app pods creation (3). <br/><br/><img src="./images/dent-deletion-2-4-3.png" width="800" /> |
...
| **Action** &nbsp; 4.1.4 | Paste the **webhook address** in the Payload URL (1). Change the content type to **application/json** (2). Click **Add webhook** (3).<br/><br/><img src="./images/dent-deletion-4-1-4.png" width="800" /> |
...
| **Action** &nbsp; 6.1.1 | Open **Menu** (1) and select **Run** (2) > **Integrations** (3). <br/><br/><img src="./images/dent-deletion-6-1-1.png" width="800" /> |
