...
| **Action** 1.1.1 | Open Cloud Pak for Integration using the URL saved from demo preparation step 2.9. Click **IBM provided credentials (admin only)**.<br/><br/><img src="./images/dent-deletion-1-1-1.png" width="800" /> |
...
| :--- | :--- |
| **Narration** | This is the IBM Cloud Pak for Integration home screen, which shows all the capabilities of the Cloud Pak in one place. Specialized integration capabilities for API management, application integration, messaging, and more, are built on top of powerful automation services.<br/><br/> Let’s see the integration capabilities available. |
...
| **Action** 1.3.1 | Show the **Integration instances** page. In the row with **Type: Integration dashboard**, click **ace-dashboard-demo**.<br/><br/><img src="./images/image1.3.1.png" width="800" /> |
...
| **Action** 2.4.4 | Return to the App Connect Dashboard page. When the status indicates **Ready**, click the **simple-echo-app server**. <br/><br/><img src="./images/dent-deletion-2-4-4.png" width="800" /> |
| **Action** 2.4.5 | Open the **HTTPEcho** Application. <br/><br/><img src="./images/dent-deletion-2-4-5.png" width="800" /> |
| **Action** 2.4.6 | Open the **Echo** Message flow. <br/><br/><img src="./images/Prep2.4.6.png" width="800" /> |
...
| **Action** 5.2.1 | Open **Menu** (1). Select **Run** (2), then **Messaging** (3). <br/><br/><img src="./images/Script5.2.1.png" width="800" /> |
...
| **Action** 5.3.1 | Open **Menu** (1). Click **Run** (2), then **APIs** (3). <br/><br/><img src="./images/Script5.3.1.png" width="800" /> |
...
| **Action** 6.1.1 | Open **Menu** (1). Select **Run** (2), then **Integrations** (3). <br/><br/><img src="./images/Script6.1.1.png" width="800" /> |
