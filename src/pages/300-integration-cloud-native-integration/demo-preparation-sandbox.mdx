...
<InlineNotification>
<strong>NOTE</strong>: If you completed the GitHub fork previously (several weeks or more) and are reusing the same one, you may need to sync your fork to ensure your branch is updated and fully functional.
</InlineNotification>

<br/><br/><img src="./images/sync-fork.png" width="800" /><br/>
