...
5. The **cp4i-deployment-samples** folder was forked the owner specified. Take note of the URL, it is required in a later section.
...
<br/>
  ...
  <InlineNotification>To copy the repo you will need to have the <a href = "https://cli.github.com" target="_blank" rel="noreferrer">Git CLI</a> on your machine. If you don’t have it, follow the installation steps described in this page, based on your operating system.</InlineNotification><br/>
...
```
git clone -b <branchname> <your copied repo url>
```
<br/>

<InlineNotification>Do not copy the opening or closing arrows in the command. For example, the command should look like:<br/><br/>git clone -b https://github.com/ibmryan/cp4i-deployment-samples.git</InlineNotification><br/>
...
2. Set the GitHub branch to the value showing below, so the script knows which version of the GitHub artifacts to use.
