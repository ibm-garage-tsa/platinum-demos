...
2. Make sure you are in an **ITZ** account (1) and the **Product version** is **2022.2.1** (2).<br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-cloud-native-integration/images/Prep2.2.png" width="800" />
...
7. Accept the license agreement (1) and click **Install** (2) to install Cloud Pak for Integration. The installation will take up to 150 minutes.
<br/><br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-api-enabled-application-integration/images/Prep2.7.png" width="800" />

<br/>

8. You can view the progress in the schematics progress bar that automatically displays.
...
9. When the status updates to **Active** (1), you will be able to access Cloud Pak for Integration Platform Navigator. Click **Offering Dashboard** (2).
...
12. Log in using the Username **“admin”** and the 32-character password that you created previously in step 5.
...
2. Create the pipeline using this command:<br/><br/><code>./cicd-apply-test-apic-pipeline.sh -n $NAMESPACE -r $REPO -b $BRANCH</code><br/><img src="./images/prepare-6-2.png" width="800" /><br/>
