...
```
<InlineNotification>
<strong>NOTE</strong>: Do not cope the opening or closing arrows in the command. For example, the command should look like: git clone https://github.com/ibmryan/cp4i-deployment-samples.git
</InlineNotification>
...
5. Validate that there is two pipelines.
