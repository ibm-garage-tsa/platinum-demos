...
3. In the terminal output, scrool to find the **Webhook route** URL. Copy and save the URL, as shown in this screenshot. It will be require to complete step 4.1.4 of the demo.<br/><br/><img src="./images/newprep8.3" width="800" /><br/>
