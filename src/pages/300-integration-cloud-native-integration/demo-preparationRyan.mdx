...
<InlineNotification><strong>NOTE</strong>: Copy and save the URL after you click <strong>Offering Dashboard</strong>. This is your CP4I URL and will be required in step 1 of the demo script.</InlineNotification><br/>
...
12. From the **Home Page**, open the top left menu (1) and then click **Integration instances** (2) under **Administration**.<br/><img src="./images/image1.2.1.png" width="800" />

<br/>

13. The Cloud Pak for Integration capabilities are displayed in the type column.<br/><img src="./images/prep-image1.13.png" width="800" /><br/>
