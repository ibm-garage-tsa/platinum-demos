...
<summary>1 - Exploring the flight information assets</summary>
...
| **1.2** | **Exploring the Flight Information REST API in the Portal** |
| :--- | :--- |
...
| **Action** &nbsp; 1.3.1 | Bring up the Flight Information Board UI.  <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-event-endpoint-management/images/300-eem-demo-3-1-1.png" width="800" /> |

| **1.4** | **Exploring the update rate of the Flight Information Board** |
| :--- | :--- |
...
| **Action** &nbsp; 1.4.1 | Show both the Flight Information Manager and the Flight Information Board on screen at the same time. Both screens are showing the same for now.<br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-event-endpoint-management/images/300-eem-demo-4-1-1.png" width="800" /> |
| **Action** &nbsp; 1.4.2 | Click on one of the **Delay this flight** (1) buttons, enter **60** (2) for the minutes to be delayed, and click **OK** (3).<br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-event-endpoint-management/images/300-eem-demo-4-1-2.png" width="800" /> |
| **Action** &nbsp; 1.4.3 | Show that the flight departure time has been updated on the manager only.<br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-event-endpoint-management/images/300-eem-demo-4-1-3.png" width="800" /> |
| **Action** &nbsp; 1.4.4 | If required, wait 5 minutes to show that the Flight Board is updated. |
...
<summary>2 - Introducing Events, Kafka, and IBM Event Streams  </summary>

<br/>

| **2.1** | **Working with Events, Kafka, and IBM Event Streams** |
| :--- | :--- |
...
| **Action** &nbsp; 2.1.1 | Show the **IBM Event Streams** tab in the browser. <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-event-endpoint-management/images/300-eem-demo-5-1-1.png" width="800" /> |
...
| **Action** &nbsp; 2.2.1 | Navigate to **Topics** (1). Click **flight-delays** (2).<br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-event-endpoint-management/images/300-eem-demo-6-1-1.png" width="800" /> |
...
| **Action** &nbsp; 2.2.3 | Show that as you delay additional flights these show in the event stream. |
...
<summary>3 - Communicating with the Async API </summary>
...
| **Action** &nbsp; 3.1.1 | Open the Cloud Pak for Integration Platform Navigator tab and click **Design APIs**.<br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-event-endpoint-management/images/300-eem-demo-8-1-1.png" width="800" /> |
| **Action** &nbsp; 3.1.2 | Click **Develop APIs and products**.<br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-event-endpoint-management/images/300-eem-demo-8-1-2.png" width="800" /> |
| **Action** &nbsp; 3.1.3 | Select **Add** (1) in the top right, and select **AsyncAPI (from Kafka topic) (2).** <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-event-endpoint-management/images/300-eem-demo-8-1-3.png" width="800" /> |
| **Action** &nbsp; 3.1.4 | Enter **Flight Delays** in the Title field.<br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-event-endpoint-management/images/300-eem-demo-8-1-4.png" width="800" /> |
...
| **Action** &nbsp; 3.1.6 | Check **Publish this API** (1) and click **Next** (2).<br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-event-endpoint-management/images/300-eem-demo-8-1-6.png" width="800" /> |
...
| **Action** &nbsp; 3.1.7 | Click **Edit API** to continue.<br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-event-endpoint-management/images/300-eem-demo-8-1-7.png" width="800" /> |
...
| **3.2** | **Discover the Async API from an app developer’s perspective** |
| :--- | :--- |
...
| **Action** &nbsp; 3.2.3 | Click **Flight Delays auto product** (the automatically-generated product we created earlier).<br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-event-endpoint-management/images/300-eem-demo-9-1-3.png" width="800" /> |
| **Action** &nbsp; 3.2.4 | Click **Flight Delays**.<br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-event-endpoint-management/images/300-eem-demo-9-1-4.png" width="800" /> |
...
| **Action** &nbsp; 3.2.5 | Explain the screen, as highlighted in the narration above.<br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-event-endpoint-management/images/300-eem-demo-9-1-5.png" width="800" /> |

| **3.3** | **Subscribe to the Async API** |
| :--- | :--- |
...
| **Action** &nbsp; 3.3.1 | Click the arrow next to flight delays in the overview on the left, then select **Subscribe (operation)**. <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-event-endpoint-management/images/300-eem-demo-10-1-1.png" width="800" /> |
| **Action** &nbsp; 3.3.2 | Scroll down on the right hand side to the **Properties** section (1) and obtain the value for **client.id** and **bootstrap.servers** (2). <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-event-endpoint-management/images/300-eem-demo-10-1-2.png" width="800" /> |
| **Action** &nbsp; 3.3.3 | Click **Get Access** in the top left. If for any reason you are not logged into the Portal, this is the point at which you will be forced to log in.  <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-event-endpoint-management/images/300-eem-demo-10-1-3.png" width="800" /> |
...
| **Action** &nbsp; 3.3.4 | Select the **Default** pricing plan to continue. <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-event-endpoint-management/images/300-eem-demo-10-1-4.png" width="800" /> |
...
| **Action** &nbsp; 3.3.5 | Click **Create Application** on the right.<br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-event-endpoint-management/images/300-eem-demo-10-1-5.png" width="800" /> |
| **Action** &nbsp; 3.3.6 | Name the **title** **Airline App** (1) and click **Save** (2). <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-event-endpoint-management/images/300-eem-demo-10-1-6.png" width="800" /> |
| **Action** &nbsp; 3.3.7 | You will now see a dialog showing the **Key** and **Secret** for this application to access the API. <br/><br/><InlineNotification><strong>NOTE</strong>: It is very important that you save these, as they cannot be retrieved later. </InlineNotification><br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-event-endpoint-management/images/300-eem-demo-10-1-7.png" width="800" /> |
| **Action** &nbsp; 3.3.8 | Close this dialog then select your newly created application on the left. <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-event-endpoint-management/images/300-eem-demo-10-1-8.png" width="800" /> |
| **Action** &nbsp; 3.3.9 | Review the details then click **Next**. Your subscription will be complete. <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-event-endpoint-management/images/300-eem-demo-10-1-9.png" width="800" /> |
...
<summary>4 - Consuming the events </summary>
