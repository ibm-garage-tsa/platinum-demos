...
<br/><br/><img src="./images/integration-instances.png" width="800" />
...
```
<br/><br/><img src="./images/prepare-2-1.png" width="800" /><br/>
...
8. Complete the form.<InlineNotification><strong>SUGGESTION</strong>: Use devuser as the username, and you are welcome to use your personal email address.</InlineNotification><br/><img src="./images/prep-image2.5.png" width="800" />

9. To complete your registration, you need to open your email and accept the registration. <InlineNotification><strong>NOTE</strong>: If you are using mailtrap, you need to open your mailtrap inbox and accept the registration.</InlineNotification><br/><img src="./images/prep-image2.5.png" width="800" />
