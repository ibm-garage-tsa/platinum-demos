...
2. Select the **topics** (1) icon, and click **Create Topic** (2).<br/><br/><img src="./images/prep-7-2.png" width="800" /><br/>
...
Click **Save**.<br/><br/><img src="./images/prep-9-5.png" width="800" /><br/>

6. The Event Gateway Service needs to be associated with the API Connect Catalog. Navigate to API Management by selecting the menu at the top left and selecting **APIs** under the **Design** section.<br/><br/><img src="./images/prep-9-6.png" width="800" /><br/>

7. Select **Manage** (1) and click on the **Sandbox** (2) catalog.<br/><br/><img src="./images/prep-9-7.png" width="800" /><br/>

8. Select the **Catalog settings** (1) tab, then the **Gateway** services section (2) and click **Edit** (3).<br/><br/><img src="./images/prep-9-8.png" width="800" /><br/>

9. Check the box associated with the **event-gateway-service** (1) and click **Save (2)**.<br/><br/><img src="./images/prep-9-9.png" width="800" /><br/>
...
1. Select the **draft** icon (1). Click **Add** and select **API** (2).<br/><br/><img src="./images/prep-11-1.png" width="800" /><br/>

2. Scroll down and select **Exiting OpenAPI** (1) and click **Next** (2).<br/><br/><img src="./images/prep-11-2.png" width="800" /><br/>

3. Download the file from <a href="LOCAL PENDING" target="_blank" rel="noreferrer">here</a>, upload as the API source, and click **Next**.<br/><br/><img src="./images/prep-11-3.png" width="800" /><br/>

4. Check the **Activate API** (1) option. Click **Next** (2).<br/><br/><img src="./images/prep-11-4.png" width="800" /><br/>

5. Check **Develop**.<br/><br/><img src="./images/prep-11-5.png" width="800" /><br/>
...
1. Click on the **Home** icon (1), and **Manage catalogs** (2).<br/><br/><img src="./images/prep-12-1.png" width="800" /><br/>

2. Open **Sandbox**.<br/><br/><img src="./images/prep-12-2.png" width="800" /><br/>

3. Open **Catalog settings** (1), then **Portal** (2).<br/><br/><img src="./images/prep-12-3.png" width="800" /><br/>

4. Since a developer portal does not already exist, click **Create**.<br/><br/><img src="./images/prep-12-4.png" width="800" /><br/>

5. Select **portal-service** (1) from the pull down. Click **Create** (2).<br/><br/><img src="./images/prep-12-5.png" width="800" /><br/>
...
7. On the Portal page, click **Create account**.<br/><br/><img src="./images/prep-12-7.png" width="800" /><br/>

8. Complete the form.

<InlineNotification><strong>SUGGESTION</strong>: Use devuser as the username, and you are welcome to use your personal email address.</InlineNotification><br/><img src="./images/prep-12-8.png" width="800" />

9. To complete your registration, you need to open your email and accept the registration.

<InlineNotification><strong>NOTE</strong>: If you are using mailtrap, you need to open your mailtrap inbox and accept the registration.</InlineNotification><br/><img src="./images/prep-12-9.png" width="800" />
