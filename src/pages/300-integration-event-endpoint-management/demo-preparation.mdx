...
<InlineNotification><strong>SUGGESTION</strong>: Use devuser as the username, and you are welcome to use your personal email address.</InlineNotification><br/><img src="./images/prep-11-8.png" width="800" /><br/>

9. To complete your registration, you need to open your email and accept the registration.<br/><br/>

<InlineNotification><strong>NOTE</strong>: If you are using mailtrap, you need to open your mailtrap inbox and accept the registration.<br/><br/></InlineNotification><br/><img src="./images/prep-11-9.png" width="800" />
