...
1. To provision a ROKS cluster on Red Hat OpenShift, go <a href="https://techzone.ibm.com/my/reservations/create/62f1112aeeb0ab0017dc7608" target="_blank" rel="noreferrer">here</a> and complete the form.
<br/>
...
3. You will receive a second email once the environment is provisioned. You should expect this to take between 30 and 120 minutes. This email contains information, such as URLs, allowing you to connect to the instance.<br/><img src="./images/prep-1-3.png" width="800" />
...
1. Click the **Cluster URL** from the enviroment confirmation email. Log into IBM Cloud using your IBMid.<br/><img src="./images/prep-2-1.png" width="800" /><br/>
...
4. Enter **cp4i** as the **Project** (1) name. Click **Add** (2).<br/><br/><img src="./images/prep-image2.4.png" width="800" />
...
10. When the status is **Active**, you will be able to access Cloud Pak for Integration Platform Navigator. Select **Offering Dashboard** on the upper right corner of the page.<br/><br/><img src="./images/prep-2-10.png" width="800" /><br/>
...
<br/><br/><img src="./images/prep-2-12.png" width="800" /><br/>

13. Click **Integration instances**.
<br/><br/><img src="./images/prep-2-13.png" width="800" />
...
2. Select you **CP4I ROKS** cluster.
<br/><br/><img src="./images/prep-3-2.png" width="800" />

<br/>

3. Click **Open your Managed OpenShift (ROKS) environment**.
<br/><br/><img src="./images/prep-3-3.png" width="800" />

<br/>

4. Click **OpenShift web console**.
<br/><br/><img src="./images/prep-3-4.png" width="800" />

<br/>

5. On the web console page, click **?** (1), and select **Command line tools** (2).
<br/><br/><img src="./images/prep-3-5.png" width="800" />

<br/>

6. Follow the links to install the OpenShift Command Line Interface (CLI) for your Operating System.
<br/><br/><img src="./images/prep-3-6.png" width="800" />
...
<br/><img src="./images/prep-4-1.png" width="800" />
...
```
git clone https://github.ibm.com/IntegrationPlatinumDemos/eem-demo.git
```
...
<br/><br/><img src="./images/prep-5-2-2.png" width="800" /><br/>
...
The Platform Navigator, Event API, Event Management and Event Streams UI endpoints are displayed at the end of the script for convenience, these will be used later.
...
1. Navigate to the Event Stream UI outputted in the previous step.
<br/><br/><img src="./images/prep-7-1.png" width="800" /><br/>

<br/>

2. Select the **topics** (1) icon, and click **Create Topic** (2).
<br/><br/><img src="./images/prep-7-2.png" width="800" /><br/>

<br/>

3. Specify **flight-delays** (1) as the Topic name and select **Next** (2).
<br/><br/><img src="./images/prep-7-3.png" width="800" /><br/>

<br/>

4. Click **Next**.
<br/><br/><img src="./images/prep-7-4.png" width="800" /><br/>

<br/>

5. Click **Next**.
<br/><br/><img src="./images/prep-7-5.png" width="800" /><br/>

<br/>

6. Click **Create topic**.
<br/><br/><img src="./images/prep-7-6.png" width="800" /><br/>
...
1. Open the Cloud Pak for Integration Platform Navigator Home page from section 2 above. Using the menu in the top left, expand Administration and select Integration instances.
<br/><br/><img src="./images/prep-9-1.png" width="800" /><br/>

2. Select **ademo** corresponding to the **API management administration** type.
<br/><br/><img src="./images/prep-9-2.png" width="800" /><br/>

3. Select **Topology** (1), and click **Register service** (2).
<br/><br/><img src="./images/prep-9-3.png" width="800" /><br/>

4. Select **Event Gateway Service**.
<br/><br/><img src="./images/prep-9-4.png" width="800" /><br/>

5. Configure the detail, using:
- **Title**: event-gateway-service <br/>
- **Management endpoint**: the value outputted from the setup-software.sh command (note that this **should** begin with https://) <br/>
- **API endpoint base**: the value outputted from the setup-software.sh command (note that this should **NOT** begin with https://)

<br/>

Click **Save**.
<br/><br/><img src="./images/prep-9-5.png" width="800" /><br/>

6. The Event Gateway Service needs to be associated with the API Connect Catalog. Navigate to API Management by selecting the menu at the top left and selecting **APIs** under the **Design** section.
<br/><br/><img src="./images/prep-9-6.png" width="800" /><br/>

7. Select **Manage** (1) and click on the **Sandbox** (2) catalog.
<br/><br/><img src="./images/prep-9-7.png" width="800" /><br/>

8. Select the **Catalog settings** (1) tab, then the **Gateway** services section (2) and click Edit (3).
<br/><br/><img src="./images/prep-9-8.png" width="800" /><br/>

9. Check the box associated with the **event-gateway-service** (1) and click **Save (2)**.
<br/><br/><img src="./images/prep-9-9.png" width="800" /><br/>
...
<summary>10 - Set up the client certificates </summary>
...
<summary>11 - Import and deploy the Flight API </summary>
...
1. Select the **draft** icon (1). Click **Add** and select **API** (2).
<br/><br/><img src="./images/prep-11-1.png" width="800" /><br/>

2. Scroll down and select **Exiting OpenAPI** (1) and click **Next** (2).
<br/><br/><img src="./images/prep-11-2.png" width="800" /><br/>

3. Download the file from <a href="LOCAL PENDING" target="_blank" rel="noreferrer">here</a>, upload as the API source, and click **Next**.
<br/><br/><img src="./images/prep-11-3.png" width="800" /><br/>

4. Check the **Activate API** (1) option. Click **Next** (2).
<br/><br/><img src="./images/prep-11-4.png" width="800" /><br/>

5. Check **Develop**.
<br/><br/><img src="./images/prep-11-5.png" width="800" /><br/>
...
<summary>12 - Create Dev User for the Developer Portal  </summary>

<br/>

1. Click on the **Home** icon (1), and **Manage catalogs** (2).
<br/><br/><img src="./images/prep-12-1.png" width="800" /><br/>

2. Open **Sandbox**.
<br/><br/><img src="./images/prep-12-2.png" width="800" /><br/>

3. Open **Catalog settings** (1), then **Portal** (2).
<br/><br/><img src="./images/prep-12-3.png" width="800" /><br/>

4. Since a developer portal does not already exist, click **Create**.
<br/><br/><img src="./images/prep-12-4.png" width="800" /><br/>

5. Select **portal-service** (1) from the pull down. Click **Create** (2).
<br/><br/><img src="./images/prep-12-5.png" width="800" /><br/>

6. The portal will take around 5 minutes to be built, but the URL is immediately displayed. Copy the URL, open a new browser tab, and paste your **Portal URL**. It may take several minutes and browser refreshes to appear.
<br/><br/><img src="./images/prep-12-6.png" width="800" /><br/>

7. On the Portal page, click **Create account**.
<br/><br/><img src="./images/prep-12-7.png" width="800" /><br/>

8. Complete the form.<InlineNotification><strong>SUGGESTION</strong>: Use devuser as the username, and you are welcome to use your personal email address.</InlineNotification><br/><img src="./images/prep-12-8.png" width="800" />

9. To complete your registration, you need to open your email and accept the registration. <InlineNotification><strong>NOTE</strong>: If you are using mailtrap, you need to open your mailtrap inbox and accept the registration.</InlineNotification><br/><img src="./images/prep-12-9.png" width="800" />
...
**TIP**: These URLs are provided as the output from the setup-software.sh and setup-app.sh scripts. For convenience you can also get the URLs for the above by running the following command from the eem-demo/scripts folder: <br/>
```
$ ./get-urls.sh
```

2. Log in to the Developer Portal using the devuser account you created in the preparation steps above.
<br/><br/><img src="./images/prep-demo-2.png" width="800" /><br/>

<br/>

3. Enter the **Username** and **Password**. Click **Sign in**.
<br/><br/><img src="./images/prep-demo-3.png" width="800" /><br/>

4. Prepare a terminal by logging into the OpenShift cluster with the “Copy login command” option from the OpenShift user interface, then executing it within the terminal window.
<br/><br/><img src="./images/prep-demo-4.png" width="800" /><br/>
