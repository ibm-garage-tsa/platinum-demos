...
<br/><InlineNotification><strong>NOTE</strong>: Currently password validation is not enforced on this page. If you proceed with an invalid password you will be able to start the installation but it will fail. There is no way to recover from this error other than provisioning a new cluster.</InlineNotification><br/><br/><img src="./images/prep-2-5.png" width="800" /><br/>
...
12. Log in using the admin userid and password you created in step 5.<br/><br/><img src="./images/prep-2-12.png" width="800" /><br/>

13. Click **Integration instances**.<br/><br/><img src="./images/prep-2-13.png" width="800" />

<br/>

14. The parts of the Cloud Pak (API Connect, App Connect Designer, App Connect Dashboard and Asset Repository) will display here. Additional instances for any of the integration capabilities can be created by selecting **Create capability**.<br/><br/><img src="./images/prep-2-13.png" width="800" />
