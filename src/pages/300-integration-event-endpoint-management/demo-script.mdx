...
| **Action** &nbsp; 11.1.4 | Now return to the terminal window where the script was run, and you will see a message.  <br/><br/><img src="./images/300-eem-demo-11-1-4.png" width="800" /><br/> |
