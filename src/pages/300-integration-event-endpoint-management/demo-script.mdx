...
| **Action** &nbsp; 2.1.1 | Bring up the Flight Information Board UI.  <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-event-endpoint-management/images/300-eem-demo-2-1-1.png" width="800" /> |
...
<summary>3 - Introducing IBM Event Streams </summary>
...
| **Action** &nbsp; 3.2.3 | Show that as you delay additional flights these show in the event stream. |
...
| **5.1** | **Discover the Async API from an app developer’s perspective** |
| :--- | :--- |
...
| **5.2** | **Subscribe to the Async API** |
| :--- | :--- |
