...
| **Action** &nbsp; 5.3.5 | Now return to the terminal window where the script was run, and you will see a message.  <br/><br/>"Your flight EZY 6005 has been delayed by 180 minutes. You can eat at ACME Restaurant and get a 10% discount! Would you like to book a table before the others on your plane take them all?" |
