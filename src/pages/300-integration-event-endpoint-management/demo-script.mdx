...
| **Action** &nbsp; 2.1.1 | Show the IBM API Connect Developer Portal tab in the browser. <br/><br/> <img src="./images/300-eem-demo-2-1-1.png" width="800" /> |
| **Action** &nbsp; 2.1.2 | Click **API Products**. <br/><br/> <img src="./images/300-eem-demo-2-1-2.png" width="800" /> |
| **Action** &nbsp; 2.1.3 | Click **Flight API**. <br/><br/> <img src="./images/300-eem-demo-2-1-3.png" width="800" /> |
| **Action** &nbsp; 2.1.4 | Click **Flight API 1.0.0**. <br/><br/> <img src="./images/300-eem-demo-2-1-4.png" width="800" /> |
| **Action** &nbsp; 2.1.5 | Click the **GET /flights** operation. <br/><br/> <img src="./images/300-eem-demo-2-1-5.png" width="800" /> |
...
| **Action** &nbsp; 3.1.1 | Bring up the Flight Information Board UI.  <br/><br/> <img src="./images/300-eem-demo-3-1-1.png" width="800" /> |
...
| **Action** &nbsp; 4.1.1 | Show both the Flight Information Manager and the Flight Information Board on screen at the same time. <br/><br/> <img src="./images/300-eem-demo-4-1-1.png" width="800" /> |
| **Action** &nbsp; 4.1.2 | Click on one of the **Delay this flight** (1) buttons, enter **60** (2) for the minutes to be delayed, and click **OK** (3).<br/><br/> <img src="./images/300-eem-demo-4-1-2.png" width="800" /> |
| **Action** &nbsp; 4.1.3 | Show that the flight departure time has been updated on the manager only.<br/><br/> <img src="./images/300-eem-demo-4-1-3.png" width="800" /> |
...
| **Action** &nbsp; 5.1.1 | Show the **IBM Event Streams** tab in the browser. <br/><br/> <img src="./images/300-eem-demo-5-1-1.png" width="800" /> |
...
| **Action** &nbsp; 6.1.1 | Navigate to **Topics** (1). Click **flight-delays** (2).<br/><br/> <img src="./images/300-eem-demo-6-1-1.png" width="800" /> |
| **Action** &nbsp; 6.1.2 | The events already emitted will be displayed. Select the top event (1) and show this corresponds to the flight you previously delayed (2). <br/><br/> <img src="./images/300-eem-demo-6-1-2.png" width="800" /> |
...
| **Action** &nbsp; 8.1.1 | Open the Cloud Pak for Integration Platform Navigator tab and click **Design APIs**.<br/><br/> <img src="./images/300-eem-demo-8-1-1.png" width="800" /> |
| **Action** &nbsp; 8.1.2 | Click **Develop APIs and products**.<br/><br/> <img src="./images/300-eem-demo-8-1-2.png" width="800" /> |
| **Action** &nbsp; 8.1.3 | Select **Add** (1) in the top right, and select **AsyncAPI (from Kafka topic) (2).** <br/><br/> <img src="./images/300-eem-demo-8-1-3.png" width="800" /> |
| **Action** &nbsp; 8.1.4 | Enter **Flight Delays** in the Title field.<br/><br/> <img src="./images/300-eem-demo-8-1-4.png" width="800" /> |
| **Narration** | IBM Event Endpoint Management can provide access to topics on multiple Kafka clusters via a single “event gateway”. Consumers therefore only have to connect to one bootstrap server (the event gateway) with one set of credentials regardless of which Kafka cluster their topics reside on. <br/><br/>As we add the topic to the catalogue for external exposure, we choose to provide a schema for the event data too. This ensures that all consumers of the events know what data model to expect from this topic. |
| **Action** &nbsp; 8.1.5 | Enter the Kafka listener URL from the earlier step in the **Bootstrap Servers** field (1) in the Servers section. In the Channel field enter the topic name **flight-delays** (2). Upload the **Flight-Delay.avsc** (3) schema that can be downloaded from <a href="https://raw.githubusercontent.com/IBM/platinum-demo-code-eem/main/resources/Flight-Delays.avsc" target="_blank" rel="noreferrer">here</a>. Click **Next** (4).<br/><br/> <img src="./images/300-eem-demo-8-1-5.png" width="800" /> |
...
| **Action** &nbsp; 8.1.6 | Check **Publish this API** (1) and click **Next** (2).<br/><br/> <img src="./images/300-eem-demo-8-1-6.png" width="800" /> |
...
| **Action** &nbsp; 8.1.7 | Click **Edit API** to continue.<br/><br/> <img src="./images/300-eem-demo-8-1-7.png" width="800" /> |
...
| **Action** &nbsp; 8.1.8 | The next screen is the Edit API screen, but you do not need to do anything here.  Simply ensure that the **online switch** is green, indicating the API is online. <br/><br/> <img src="./images/300-eem-demo-8-1-8.png" width="800" /> |
...
| **Action** &nbsp; 9.1.1 | Go to the API Connect Developer Portal tab and click on **API Products**. Note that if you are already on the API Products page, you may need to refresh the browser page as we have added a new AsyncAPI product since you were last here. <br/><br/> <img src="./images/300-eem-demo-9-1-1.png" width="800" /> |
| **Action** &nbsp; 9.1.2 | Explain the two entries, as highlighted in the narration above. <br/><br/> <img src="./images/300-eem-demo-9-1-2.png" width="800" /> |
...
| **Action** &nbsp; 9.1.3 | Click **Flight Delays auto product**.<br/><br/> <img src="./images/300-eem-demo-9-1-3.png" width="800" /> |
| **Action** &nbsp; 9.1.4 | Click **Flight Delays**.<br/><br/> <img src="./images/300-eem-demo-9-1-4.png" width="800" /> |
...
| **Action** &nbsp; 9.1.5 | Explain the screen, as highlighted in the narration above.<br/><br/> <img src="./images/300-eem-demo-9-1-5.png" width="800" /> |
...
| **Action** &nbsp; 10.1.1 | Click the arrow next to flight delays in the overview on the left, then select **Subscribe (operation)**. <br/><br/> <img src="./images/300-eem-demo-10-1-1.png" width="800" /> |
| **Action** &nbsp; 10.1.2 | Scroll down on the right hand side to the properties section and obtain the value for **client.id** and **bootstrap.servers**. <br/><br/> <img src="./images/300-eem-demo-10-1-2.png" width="800" /> |
| **Action** &nbsp; 10.1.3 | Click **Get Access** in the top left. If for any reason you are not logged into the Portal, this is the point at which you will be forced to log in.  <br/><br/> <img src="./images/300-eem-demo-10-1-3.png" width="800" /> |
...
| **Action** &nbsp; 10.1.4 | Select the **default** pricing plan to continue. <br/><br/> <img src="./images/300-eem-demo-10-1-4.png" width="800" /> |
...
| **Action** &nbsp; 10.1.5 | Click **Create Application** on the right.<br/><br/> <img src="./images/300-eem-demo-10-1-5.png" width="800" /> |
| **Action** &nbsp; 10.1.6 | Provide a title for your application (1) and click **Save** (2). <br/><br/> <img src="./images/300-eem-demo-10-1-6.png" width="800" /> |
| **Action** &nbsp; 10.1.7 | You will now see a dialog showing the Key and Secret for this application to access the API. It is very important that you save these, as they cannot be retrieved later. <br/><br/> <img src="./images/300-eem-demo-10-1-7.png" width="800" /> |
| **Action** &nbsp; 10.1.8 | Close this dialog then select your newly created application on the left. <br/><br/> <img src="./images/300-eem-demo-10-1-8.png" width="800" /> |
| **Action** &nbsp; 10.1.9 | Review the details then click **Next**. Your subscription will be complete. <br/><br/> <img src="./images/300-eem-demo-10-1-9.png" width="800" /> |
...
| **Action** &nbsp; 11.1.1 | Install the server certificate from the event gateway endpoint ready for the client application. There is a script to do this:<br/><br/><code>./install-certificate.sh</code><br/><br/><img src="./images/300-eem-demo-11-1-1.png" width="800" /> |
| **Narration** | The example in our demo is simply a java consumer that simulates the way the Airline App would receive Kafka events, such that we can see them arriving in real time. <br/><br/> The script that runs the consumer code itself is called ./setup-client-app.sh and is one of the files you downloaded in the beginning. This takes five arguments: <br/><br/> 1) Target Namespace: this is normally cp4i <br/><br/>2) Kafka Client Id: this is retrieved from the Developer Portal in the properties section<br/><br/> <img src="./images/300-eem-demo-11-1-1-clientid.png" width="800" /> <br/>3)Gateway Username: this is the API Key that you copied in this step.<br/><br/> <img src="./images/300-eem-demo-11-1-1-apikey.png" width="800" /> <br/>4)Gateway Password: this is the API secret also shown in the above.<br/><br/> <img src="./images/300-eem-demo-11-1-1-apisecret.png" width="800" /> <br/ <br/><br/>5) Flight Number: this is the flight number you want to monitor. This needs to be within quotes, e.g. "EZY 6005" |
...
| **Action** &nbsp; 11.1.3 | In the Flight Information Manager, click the button to delay the flight you entered in the consumer app.  Enter a number of minutes (1), then click **OK** (2). <br/><br/> <img src="./images/300-eem-demo-11-1-3.png" width="800" /> <br/> |
| **Action** &nbsp; 11.1.4 | Now return to the terminal window where the script was run, and you will see a message.  <br/><br/><Your flight EZY 6005 has been delayed by 180 minutes.
Why not pop back to the ACME Restaurant and have a meal at a 10% discount? Would you like to book a table before the others on your plane take them all! |
| **Narration** | We see the following message, which of course in real life would appear as on the airline mobile app alongside the delay notification.<br/><br/>"Your flight EZY 6005 has been delayed by 180 minutes. <br/><br/>Why not pop back to the ACME Restaurant and have a meal at a 10% discount? Would you like to book a table before the others on your plane take them all!"<br/><br/>Notice that it takes a while before the flight board shows the delay, since it is still using API polling to get flight information. <br/><br/><img src="./images/300-eem-demo-11-1-5.png" width="800" /><br/> |
