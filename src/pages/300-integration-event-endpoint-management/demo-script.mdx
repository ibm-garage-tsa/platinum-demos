...
| **Action** &nbsp; 1.1.1 | Show the Flight Information Manager UI, as highlighted in the narration above. <br/><br/> <img src="./images/300-api-demo-1-1-1.png" width="800" /> |
...
| **Action** &nbsp; 2.1.2 | Click **API Products**. <br/><br/> <img src="./images/300-api-demo-2-1-1.png" width="800" /> |
| **Action** &nbsp; 2.1.3 | Click **Flight API**. <br/><br/> <img src="./images/300-api-demo-2-1-1.png" width="800" /> |
| **Action** &nbsp; 2.1.4 | Click **Flight API 1.0.0**. <br/><br/> <img src="./images/300-api-demo-2-1-1.png" width="800" /> |
| **Action** &nbsp; 2.1.5 | Click the **GET /flights** operation. <br/><br/> <img src="./images/300-api-demo-2-1-1.png" width="800" /> |
...
| **Action** &nbsp; 3.1.1 | Bring up the Flight Information Board UI.  <br/><br/> <img src="./images/300-api-demo-2-1-1.png" width="800" /> |
...
| **Action** &nbsp; 4.1.1 | Show both the Flight Information Manager and the Flight Information Board on screen at the same time. <br/><br/> <img src="./images/300-api-demo-2-1-1.png" width="800" /> |
| **Action** &nbsp; 4.1.2 | Click on one of the **Delay this flight** (1) buttons, enter **60** (2) for the minutes to be delayed, and click **OK** (3).<br/><br/> <img src="./images/300-api-demo-2-1-1.png" width="800" /> |
| **Action** &nbsp; 4.1.3 | Show that the flight departure time has been updated on the manager only.<br/><br/> <img src="./images/300-api-demo-2-1-1.png" width="800" /> |
...
| **Action** &nbsp; 5.1.1 | Show the **IBM Event Streams** tab in the browser. <br/><br/> <img src="./images/300-api-demo-2-1-1.png" width="800" /> |
...
| **Action** &nbsp; 6.1.1 | Navigate to **Topics** (1). Click **flight-delays** (2).<br/><br/> <img src="./images/300-api-demo-2-1-1.png" width="800" /> |
| **Action** &nbsp; 6.1.2 | The events already emitted will be displayed. Select the top event (1) and show this corresponds to the flight you previously delayed (2). <br/><br/> <img src="./images/300-api-demo-2-1-1.png" width="800" /> |
...
| **Action** &nbsp; 8.1.1 | Open the Cloud Pak for Integration Platform Navigator tab and click **Design APIs**.<br/><br/> <img src="./images/300-api-demo-2-1-1.png" width="800" /> |
| **Action** &nbsp; 8.1.2 | Click **Develop APIs and products**.<br/><br/> <img src="./images/300-api-demo-2-1-1.png" width="800" /> |
| **Action** &nbsp; 8.1.3 | Select **Add** in the top right, and select **AsyncAPI (from Kafka topic).** <br/><br/> <img src="./images/300-api-demo-2-1-1.png" width="800" /> |
| **Action** &nbsp; 8.1.4 | Enter **Flight Delays** in the Title field.<br/><br/> <img src="./images/300-api-demo-2-1-1.png" width="800" /> |
...
| **Action** &nbsp; 8.1.6 | Check **Publish this API** (1) and click **Next** (2).<br/><br/> <img src="./images/300-api-demo-2-1-1.png" width="800" /> |
...
| **Action** &nbsp; 8.1.7 | Click **Edit API** to continue.<br/><br/> <img src="./images/300-api-demo-2-1-1.png" width="800" /> |
...
| **Action** &nbsp; 8.1.8 | The next screen is the Edit API screen, but you do not need to do anything here.  Simply ensure that the **online switch** is green, indicating the API is online. <br/><br/> <img src="./images/300-api-demo-2-1-1.png" width="800" /> |
...
| **Action** &nbsp; 9.1.1 | Go to the API Connect Developer Portal tab and click on **API Products**. Note that if you are already on the API Products page, you may need to refresh the browser page as we have added a new AsyncAPI product since you were last here. <br/><br/> <img src="./images/300-api-demo-2-1-1.png" width="800" /> |
| **Action** &nbsp; 9.1.2 | Explain the two entries, as highlighted in the narration above. <br/><br/> <img src="./images/300-api-demo-2-1-1.png" width="800" /> |
...
| **Action** &nbsp; 9.1.3 | Click **Flight Delays auto product**.<br/><br/> <img src="./images/300-api-demo-2-1-1.png" width="800" /> |
| **Action** &nbsp; 9.1.4 | Click **Flight Delays**.<br/><br/> <img src="./images/300-api-demo-2-1-1.png" width="800" /> |
...
| **Action** &nbsp; 9.1.5 | Explain the screen, as highlighted in the narration above.<br/><br/> <img src="./images/300-api-demo-2-1-1.png" width="800" /> |
...
| **Action** &nbsp; 10.1.1 | Click the arrow next to flight delays in the overview on the left, then select **Subscribe (operation)**. <br/><br/> <img src="./images/300-api-demo-2-1-1.png" width="800" /> |
| **Action** &nbsp; 10.1.2 | Scroll down on the right hand side to the properties section and obtain the value for **client.id** and **bootstrap.servers**. <br/><br/> <img src="./images/300-api-demo-2-1-1.png" width="800" /> |
| **Action** &nbsp; 10.1.3 | Click **Get Access** in the top left. If for any reason you are not logged into the Portal, this is the point at which you will be forced to log in.  <br/><br/> <img src="./images/300-api-demo-2-1-1.png" width="800" /> |
...
| **Action** &nbsp; 10.1.4 | Select the **default** pricing plan to continue. <br/><br/> <img src="./images/300-api-demo-2-1-1.png" width="800" /> |
...
| **Action** &nbsp; 10.1.5 | Click **Create Application** on the right.<br/><br/> <img src="./images/300-api-demo-2-1-1.png" width="800" /> |
| **Action** &nbsp; 10.1.6 | Provide a title for your application and click **Save**. <br/><br/> <img src="./images/300-api-demo-2-1-1.png" width="800" /> |
| **Action** &nbsp; 10.1.7 | You will now see a dialog showing the Key and Secret for this application to access the API. It is very important that you save these, as they cannot be retrieved later. <br/><br/> <img src="./images/300-api-demo-2-1-1.png" width="800" /> |
| **Action** &nbsp; 10.1.8 | Close this dialog then select your newly created application on the left. <br/><br/> <img src="./images/300-api-demo-2-1-1.png" width="800" /> |
| **Action** &nbsp; 10.1.9 | Review the details then click **Next**. Your subscription will be complete. <br/><br/> <img src="./images/300-api-demo-2-1-1.png" width="800" /> |
...
| **Action** &nbsp; 11.1.3 | In the Flight Information Manager, click the button to delay the flight you entered in the consumer app.  Enter a number of minutes, then click **OK**. |
| **Action** &nbsp; 11.1.4 | Now return to the terminal window where the script was run, and you will see a message.  <br/><br/><img src="./images/300-api-demo-2-1-1.png" width="800" /><br/> |
