...
| **Action** &nbsp; 1.2.2 | Show the IBM API Connect Developer Portal tab in the browser. <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-event-endpoint-management/images/300-eem-demo-2-1-2.png" width="800" /> |
| **Action** &nbsp; 1.2.3 | Click **API Products**. <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-event-endpoint-management/images/300-eem-demo-2-1-3.png" width="800" /> |
| **Action** &nbsp; 1.2.4 | Click **Flight API**. <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-event-endpoint-management/images/300-eem-demo-2-1-4.png" width="800" /> |
| **Action** &nbsp; 1.2.5 | Click **Flight API 1.0.0**. <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-event-endpoint-management/images/300-eem-demo-2-1-5.png" width="800" /> |
| **Action** &nbsp; 1.2.6 | Click the **GET /flights** operation. <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-event-endpoint-management/images/300-eem-demo-2-1-6.png" width="800" /> |
...
| **Action** &nbsp; 2.1.1 | Bring up the Flight Information Board UI.  <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-event-endpoint-management/images/300-eem-demo-3-1-1.png" width="800" /> |
...
| **Action** &nbsp; 2.2.2 | Click on one of the **Delay this flight** (1) buttons, enter **60** (2) for the minutes to be delayed, and click **OK** (3).<br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-event-endpoint-management/images/300-eem-demo-4-1-2.png" width="800" /> |
| **Action** &nbsp; 2.2.3 | Show that the flight departure time has been updated on the manager only.<br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-event-endpoint-management/images/300-eem-demo-4-1-3.png" width="800" /> |
...
| **Action** &nbsp; 3.1.1 | Show the **IBM Event Streams** tab in the browser. <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-event-endpoint-management/images/300-eem-demo-5-1-1.png" width="800" /> |
...
| **Action** &nbsp; 3.2.1 | Navigate to **Topics** (1). Click **flight-delays** (2).<br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-event-endpoint-management/images/300-eem-demo-6-1-1.png" width="800" /> |
...
| **Action** &nbsp; 3.3.1 | Click **Connect to this topic** (1). Click **flight-delays** (2).<br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-event-endpoint-management/images/300-eem-demo-7-1-1.png" width="800" /> |
...
| **Action** &nbsp; 4.1.1 | Open the Cloud Pak for Integration Platform Navigator tab and click **Design APIs**.<br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-event-endpoint-management/images/300-eem-demo-8-1-1.png" width="800" /> |
| **Action** &nbsp; 4.1.2 | Click **Develop APIs and products**.<br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-event-endpoint-management/images/300-eem-demo-8-1-2.png" width="800" /> |
| **Action** &nbsp; 4.1.3 | Select **Add** (1) in the top right, and select **AsyncAPI (from Kafka topic) (2).** <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-event-endpoint-management/images/300-eem-demo-8-1-3.png" width="800" /> |
| **Action** &nbsp; 4.1.4 | Enter **Flight Delays** in the Title field.<br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-event-endpoint-management/images/300-eem-demo-8-1-4.png" width="800" /> |
...
| **Action** &nbsp; 4.1.6 | Check **Publish this API** (1) and click **Next** (2).<br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-event-endpoint-management/images/300-eem-demo-8-1-6.png" width="800" /> |
...
| **Action** &nbsp; 4.1.7 | Click **Edit API** to continue.<br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-event-endpoint-management/images/300-eem-demo-8-1-7.png" width="800" /> |
...
| **Action** &nbsp; 5.1.2 | Explain the two entries, as highlighted in the narration above. <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-event-endpoint-management/images/300-eem-demo-9-1-2.png" width="800" /> |
...
| **Action** &nbsp; 5.1.3 | Click **Flight Delays auto product** (the automatically-generated product we created earlier).<br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-event-endpoint-management/images/300-eem-demo-9-1-3.png" width="800" /> |
| **Action** &nbsp; 5.1.4 | Click **Flight Delays**.<br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-event-endpoint-management/images/300-eem-demo-9-1-4.png" width="800" /> |
...
| **Action** &nbsp; 5.1.5 | Explain the screen, as highlighted in the narration above.<br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-event-endpoint-management/images/300-eem-demo-9-1-5.png" width="800" /> |
...
| **Action** &nbsp; 5.2.1 | Click the arrow next to flight delays in the overview on the left, then select **Subscribe (operation)**. <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-event-endpoint-management/images/300-eem-demo-10-1-1.png" width="800" /> |
...
| **Action** &nbsp; 5.2.4 | Select the **Default** pricing plan to continue. <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-event-endpoint-management/images/300-eem-demo-10-1-4.png" width="800" /> |
...
| **Action** &nbsp; 5.2.5 | Click **Create Application** on the right.<br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-event-endpoint-management/images/300-eem-demo-10-1-5.png" width="800" /> |
| **Action** &nbsp; 5.2.6 | Name the **title** **Airline App** (1) and click **Save** (2). <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-event-endpoint-management/images/300-eem-demo-10-1-6.png" width="800" /> |
...
| **Action** &nbsp; 5.2.8 | Close this dialog then select your newly created application on the left. <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-event-endpoint-management/images/300-eem-demo-10-1-8.png" width="800" /> |
| **Action** &nbsp; 5.2.9 | Review the details then click **Next**. Your subscription will be complete. <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-event-endpoint-management/images/300-eem-demo-10-1-9.png" width="800" /> |
