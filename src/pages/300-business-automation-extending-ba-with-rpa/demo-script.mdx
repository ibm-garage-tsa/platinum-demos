...
| **Actions** | Open the **Process Portal**, and log in as **customerService**. <br/><br/> ![](./images/Run-Process-with-RPA1.png)<br/><br/>Launch the **New Insurance Quote RPA** process. <br/><br/> ![](./images/Run-Process-with-RPA2.png)<br/><br/>Use the **Get Test Data** button to pre-fill the form with some test data. <br/><br/> ![](./images/Run-Process-with-RPA3.png)<br/>**Optionally**, change the name and/or the make of the car to make this request unique. <br/><br/> ![](./images/Run-Process-with-RPA4.png) <br/><br/>Click on **Get Quote** to close the task and submit the new quote request <br/><br/>**Note**: In a few seconds, see the **Quoting App** launch automatically and complete the quote. <br/><br/> ![](./images/Run-Process-with-RPA5.png) |
