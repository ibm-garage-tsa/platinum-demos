...
| **Actions** | Show the process diagram for Future Corp’s current quoting process (without RPA) in Process Designer, which you opened during the demo preparation.  <br/><br/> ![](./images/Process-without-RPA.png) |
...
| Actiond | Go to the **Process Portal** tab, which you opened during the demo preparation. Log in as **customerService** (password is **password**). <br/><br/> ![](./images/Run-Process-without-RPA1.png) |
...
| Actions | Under **Launch**, click **New Insurance Quote** to start a new quote. <br/><br/> ![](./images/Run-Process-without-RPA2.png) <br/><br/>Use the **Get Test Data** button to pre-fill in the form with some test data.<br/> <br/> ![](./images/Run-Process-without-RPA3.png) <br/><br/>**Optionally**, change the customer name and the make of the car to make this request unique. <br/><br/> ![](./images/Run-Process-without-RPA4.png) <br/><br/>Click **Get Quote** to close the task and submit the new quote request. <br/><br/> ![](./images/Run-Process-without-RPA4.png) <br/><br/> ![](./images/Run-Process-without-RPA5.png) |
...
| Actions | (Still on the Process Portal) Log out (as **customerService**), then log in as **policy1** (password is **password**).<br/> <br/> ![](./images/Run-Process-without-RPA6.png) <br/><br/>Run the newest **Prepare New Quote** task by clicking on the task name. <br/><br/> ![](./images/Run-Process-without-RPA7.png) <br/><br/>Open the legacy quoting app by using the shortcut in the bottom right of the taskbar to click on **FCQS_2021.jar**. <br/><br/> ![](./images/Run-Process-without-RPA8.png) <br/><br/>Log in to the quoting app (any username and password will work). <br/><br/> ![](./images/Run-Process-without-RPA9.png) <br/><br/>Show the task UI and the quoting app to make the point that the quote data must be manually entered into the quoting app. <br/><br/> ![](./images/Run-Process-without-RPA10.png) |
...
| Actions | In the toolbar ribbon, click on **Start** to run the bot. <br/><br/> ![](./images/New-Bot3.png)<br/><br/>The **Focus Corp Quoting System** will appear. <br/><br/> ![](./images/New-Bot4.png) |
...
| Actions | Hold the left control key and mouse over the **CREATE NEW QUOTE** button. Then, from the **Recording** menu, select **Actions**, **Click**, **By XPath**. <br/><br/> ![](./images/New-Bot18.png) <br/><br/>Finally, get the quote result. In the **Quote** app, hold the left control key and mouse over the **Total premium** field. Release the control key once the field highlights in red. Then, from the **Recording** menu, select **Actions**, **Get Value**, **By XPath**. <br/><br/> ![](./images/New-Bot19.png)<br/><br/>In the **Set Value** property page, click the icon next to the value property to assign a variable. Then, click the **New Variable** icon to create a new variable. <br/><br/> ![](./images/New-Bot20.png)<br/><br/>Name the new variable **vQuoteValue**, and click **Save** twice. <br/><br/> ![](./images/New-Bot20a.png) |
| **NARRATION** | Now we will add a command to log the quote value to the **Output** window. |
| Actions | In the toolbox, search for **log**. Drag the **Log Message** command to the bottom of the bot script. <br/><br/> ![](./images/New-Bot21.png) <br/><br/>Complete the log command by searching for and selecting the **vQuoteValue** variable. <br/><br/> ![](./images/New-Bot22.png)<br/><br/>Now let’s do a last playback of the bot by clicking **Start**. The bot will create the quote, and the quote amount will appear in the **Output** window. <br/><br/> ![](./images/New-Bot23.png) |
...
| Actions | Open the **Process Portal**, and log in as **customerService**. <br/><br/> ![](./images/Run-Process-with-RPA1.png)<br/><br/>Launch the **New Insurance Quote RPA** process. <br/><br/> ![](./images/Run-Process-with-RPA2.png)<br/><br/>Use the **Get Test Data** button to pre-fill the form with some test data. <br/><br/> ![](./images/Run-Process-with-RPA3.png)<br/><br/>**Optionally**, change the name and/or the make of the car to make this request unique. <br/><br/> ![](./images/Run-Process-with-RPA4.png) <br/><br/>Click on **Get Quote** to close the task and submit the new quote request. <br/><br/>**Note**: In a few seconds, see the **Quoting App** launch automatically and complete the quote. <br/><br/> ![](./images/Run-Process-with-RPA5.png) |
...
| Actions | Select the **Insurance Ingrid** script, and click on **Start**. <br/><br/> ![](./images/Run-chatbot1.png) <br/><br/>Type the following: **I need insurance.**  <br/><br/> ![](./images/Run-chatbot2.png) |
| **NARRATION** | The chatbot engages the customer to collect all the information needed to provide a quote. |
| Actions | Select **Car** and enter **Lexus**,**RX350**,**2021**. <br/><br/> ![](./images/Run-chatbot3.png) <br/> ![](./images/Run-chatbot4.png)<br/><br/>Enter the vehicle identification number (VIN), which typically consists of 12 characters (for example, enter **123456789012**). <br/><br/> ![](./images/Run-chatbot5.png) <br/><br/>Enter the following: **My email is mary@email.com**. <br/><br/> ![](./images/Run-chatbot6.png)<br/><br/>Enter the following: **Mary, Johnson**.<br/><br/> ![](./images/Run-chatbot7.png) <br/><br/>Enter an address such as **1 Main Street, Austin, TX 78730**. <br/><br/> ![](./images/Run-chatbot8.png)<br/><br/>Enter **yes** for quick quote. <br/><br/> ![](./images/Run-chatbot9.png) |
...
| Actions |  Enter **yes** for follow-up contact. <br/><br/> ![](./images/Run-chatbot10.png) <br/><br/>Enter **no** for anything else. <br/><br/> ![](./images/Run-chatbot11.png) |
...
| Actions | From **Chrome**, open the **Process Portal**. <br/><br/>![](./images/Quote-status1.png)<br/><br/>Log in as **customerService / password**.<br/><br/> ![](./images/Quote-status2.png)<br/><br/>Under **Dashboards**, click **Show more…**. <br/><br/>![](./images/Quote-status3.png)<br/><br/>Click to open the **Quote Status** dashboard. <br/><br/>![](./images/Quote-status4.png) |
