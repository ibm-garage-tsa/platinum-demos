...
| **Actions** | Under **Launch**, click **New Insurance Quote** to start a new quote. <br/><br/> ![](./images/Run-Process-without-RPA2.png) <br/>Use the **Get Test Data** button to pre-fill in the form with some test data.<br/> <br/> ![](./images/Run-Process-without-RPA3.png) <br/>**Optionally**, change the customer name and the make of the car to make this request unique. <br/><br/> ![](./images/Run-Process-without-RPA4.png) <br/>Click **Get Quote** to close the task and submit the new quote request. <br/><br/> ![](./images/Run-Process-without-RPA4.png) <br/><br/> ![](./images/Run-Process-without-RPA5.png) |
...
| **Actions** | (Still on the Process Portal) Log out (as **customerService**), then log in as **policy1** (password is **password**).<br/> <br/> ![](./images/Run-Process-without-RPA6.png) <br/>Run the newest **Prepare New Quote** task by clicking on the task name. <br/><br/> ![](./images/Run-Process-without-RPA7.png) <br/>Open the legacy quoting app by using the shortcut in the bottom right of the taskbar to click on **FCQS_2021.jar**. <br/><br/> ![](./images/Run-Process-without-RPA8.png) <br/>Log in to the quoting app (any username and password will work). <br/><br/> ![](./images/Run-Process-without-RPA9.png) <br/>Show the task UI and the quoting app to make the point that the quote data must be manually entered into the quoting app. <br/><br/> ![](./images/Run-Process-without-RPA10.png) |
...
| **Actions** | In the toolbar ribbon, click on **Start** to run the bot. <br/><br/> ![](./images/New-Bot3.png)<br/>The **Focus Corp Quoting System** will appear. <br/><br/> ![](./images/New-Bot4.png) |
...
| **Actions** | In the toolbar ribbon, click **Start Recorder** to capture keystrokes from the Quoting app.  <br/><br/> ![](./images/New-Bot5.png) <br/>Hold the **control** key and mouse over the **User Name** field in the Quoting app. Release the control key once the field highlights in red. Then, from the **Recording** menu, select **Actions**, **Set Value**, **By XPath**. <br/><br/> ![](./images/New-Bot6.png) <br/>On the **Set Value** property page, click the icon next to the Value to assign a variable. Then, click the **New Variable** icon to create a new variable. <br/><br/> ![](./images/New-Bot7.png) <br/>Name the new variable vUsername. Give it a default value of **mary**. Click **Save** twice. <br/><br/>![](./images/New-Bot7a.png) |
| **Narration** | Next, we'll record the password field. (In real life, we would use our Vault for entering encrypted credentials.) |
| **Actions** | Hold the left control key and mouse over the **Password** field in the **Quoting** app. Release the control key once the field highlights in red. Then, from the **Recording** menu, select **Actions**, **Set Value**, **By XPath**.<br/><br/> ![](./images/New-Bot8.png) <br/>In the **Set Value** property page, click the icon next to the value property to assign a variable. Then, click the **New Variable** icon to create a new variable. <br/><br/> ![](./images/New-Bot9.png) <br/>Name the new variable **vPassword**. Give it a default value of **123**. Click **Save** twice. <br/><br/> ![](./images/New-Bot9a.png) <br/>Hold the left control key and mouse over the **Login** button. Release the control key once the field highlights in red. Then, from the **Recording** menu, select **Actions**, **Click**, **By XPath**. <br/><br/>![](./images/New-Bot11.png) <br/>Click **Save**. <br/><br/> ![](./images/New-Bot11a.png) <br/>In the toolbar ribbon, click on **Stop Recorder**. <br/><br/> ![](./images/New-Bot12.png) |
...
| **Actions** | Close the **Quoting app**. In the menu ribbon, click **Start**.<br/><br/> ![](./images/New-Bot13.png) <br/> The Quoting app will open and automatically log in. <br/><br/> ![](./images/New-Bot14.png) |
| **Narration** | Now let’s continue to build some additional commands to enter data into the quoting bot. |
| **Actions** | In the menu ribbon, click **Start Recorder** to capture more keystrokes from the Quoting app. <br/><br/> ![](./images/New-Bot15.png) <br/>Hold the left control key and mouse over the **Driver ID** field in the Quoting app. Then, from the **Recording** menu, select **Actions**, **Set Value**, **By XPath**. <br/><br/> ![](./images/New-Bot16.png)<br/>In the **Set Value** property page, click the icon next to the value property to assign a variable. Then, click the **New Variable** icon to create a new variable. <br/><br/> ![](./images/New-Bot17.png)  <br/>Name the new variable **vDriverID**. Give it a default value of **123**. Click **Save** twice. <br/><br/> ![](./images/New-Bot17.png) <br/> ![](./images/New-Bot17a.png) <br/>Repeat for the rest of the text input fields (or stop there if you feel you’ve shown enough).|
...
| **Actions** | Hold the left control key and mouse over the **CREATE NEW QUOTE** button. Then, from the **Recording** menu, select **Actions**, **Click**, **By XPath**. <br/><br/> ![](./images/New-Bot18.png) <br/>Finally, get the quote result. In the **Quote** app, hold the left control key and mouse over the **Total premium** field. Release the control key once the field highlights in red. Then, from the **Recording** menu, select **Actions**, **Get Value**, **By XPath**. <br/><br/> ![](./images/New-Bot19.png)<br/>In the **Set Value** property page, click the icon next to the value property to assign a variable. Then, click the **New Variable** icon to create a new variable. <br/><br/> ![](./images/New-Bot20.png)<br/>Name the new variable **vQuoteValue**, and click **Save** twice. <br/><br/> ![](./images/New-Bot20a.png) |
| **Narration** | Now we will add a command to log the quote value to the **Output** window. |
| **Actions** | In the toolbox, search for **log**. Drag the **Log Message** command to the bottom of the bot script. <br/><br/> ![](./images/New-Bot21.png) <br/>Complete the log command by searching for and selecting the **vQuoteValue** variable. <br/><br/> ![](./images/New-Bot22.png)<br/>Now let’s do a last playback of the bot by clicking **Start**. The bot will create the quote, and the quote amount will appear in the **Output** window. <br/><br/> ![](./images/New-Bot23.png) |
...
| **Actions** | Open the **Process Portal**, and log in as **customerService**. <br/><br/> ![](./images/Run-Process-with-RPA1.png)<br/>Launch the **New Insurance Quote RPA** process. <br/><br/> ![](./images/Run-Process-with-RPA2.png)<br/>Use the **Get Test Data** button to pre-fill the form with some test data. <br/><br/> ![](./images/Run-Process-with-RPA3.png)<br/>**Optionally**, change the name and/or the make of the car to make this request unique. <br/><br/> ![](./images/Run-Process-with-RPA4.png) <br/>Click on **Get Quote** to close the task and submit the new quote request <br/><br/>**Note**: In a few seconds, see the **Quoting App** launch automatically and complete the quote. <br/><br/> ![](./images/Run-Process-with-RPA5.png) |
...
| **Actions** | Open the **Bot Ask and Answer** command in the bot script. <br/><br/> ![](./images/Chatbot2.png)<br/>Show how the command is connected to a knowledge base. <br/><br/> ![](./images/Chatbot3.png) <br/>If the **Knowledge Bases** tab is not visible, click the **Tools** tab on the menu ribbon, then click **Knowledge Base Training**. <br/><br/> ![](./images/Chatbot3a.png)<br/>Next, open the knowledge base definition. In the **Knowledge Bases** tab, click **IngridKB**, then click **Version 1**. <br/><br/> ![](./images/Chatbot4.png) |
...
| **Actions** | The **Knowledge Base Training** tool opens. Type the following question: **I have a policy issue with my current provider** and press **enter**. <br/><br/> ![](./images/Chatbot5.png)<br/>The maximum score is 1000. Note the low score displayed here, indicated with the red font. Type the following: **I have a problem with my policy. I want a new one.** Press **enter**. <br/><br/> ![](./images/Chatbot6.png)<br/>Again, this has resulted in a low score. Click **Select** (next to **Of course! Let’s start.**) to train the knowledge base. <br/><br/> ![](./images/Chatbot7.png)<br/>Since we have trained the knowledge base, the score now goes to a perfect 1000. Click **Retrain** to update the knowledge base.<br/><br/> ![](./images/Chatbot8.png)<br/>Now enter the first interaction again. Type the following: **I have a policy issue with my current provider. I need a new one.** Press **enter** and see how the score improved with these updates to the knowledge base.<br/><br/> ![](./images/Chatbot9.png) <br/>**Note:** Whenever you close the knowledge base, ** DO NOT SAVE** so this example works the next time you give a demo. <br/><br/> ![](./images/Chatbot10.png) <br/> ![](./images/Chatbot11.png) |
...
| **Actions** | Select the **Insurance Ingrid** script, and click on **Start**. <br/><br/> ![](./images/Run-chatbot1.png) <br/>Type the following: **I need insurance.**  <br/><br/> ![](./images/Run-chatbot2.png) |
| **Narration** | The chatbot engages the customer to collect all the information needed to provide a quote. |
| **Actions** | Select **Car** and enter **Lexus**,**RX350**,**2021**. <br/><br/> ![](./images/Run-chatbot3.png) <br/> ![](./images/Run-chatbot4.png)<br/>Enter the vehicle identification number (VIN), which typically consists of 12 characters (for example, enter **123456789012**). <br/><br/> ![](./images/Run-chatbot5.png) <br/>Enter the following: **My email is mary@email.com**. <br/><br/> ![](./images/Run-chatbot6.png)<br/>Enter the following: **Mary, Johnson**.<br/><br/> ![](./images/Run-chatbot7.png) <br/>Enter an address such as **1 Main Street, Austin, TX 78730**. <br/><br/> ![](./images/Run-chatbot8.png)<br/>Enter **yes** for quick quote. <br/><br/> ![](./images/Run-chatbot9.png) |
...
| **Actions** |  Enter **yes** for follow-up contact. <br/><br/> ![](./images/Run-chatbot10.png) <br/>Enter **no** for anything else. <br/><br/> ![](./images/Run-chatbot11.png) |
...
| **Actions** | From **Chrome**, open the **Process Portal**. <br/><br/>![](./images/Quote-status1.png)<br/>Log in as **customerService / password**.<br/><br/> ![](./images/Quote-status2.png)<br/>Under **Dashboards**, click **Show more…**. <br/><br/>![](./images/Quote-status3.png)<br/>Click to open the **Quote Status** dashboard. <br/><br/>![](./images/Quote-status4.png) |
