...
| **Actions** | Go to the **Process Portal** tab, which you opened during the demo preparation. Log in as **customerService** (password is **password**). <br/><br/> ![](./images/Run-Process-without-RPA1.png) |
