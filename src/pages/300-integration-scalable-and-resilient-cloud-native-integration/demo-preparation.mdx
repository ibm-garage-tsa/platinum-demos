...
export const Title = () => (
  <span>
    <h1 style="font-size:60px;">Scalable and resilient cloud native integration<br/> 300-level live demo</h1>
  </span>
);
...
| **Sales guidance** | Download the sales guidance document <a href="DOC TO COME" target="_blank" rel="noreferrer">here</a>. |
