...
<br/>```git clone https://github.com/callumpjackson/cloud-native-integration.git```
<br/>

2. Change  to the new cloud-native-integration directory:
<br/>```cd cloud-native-integration```
<br/>
...
<br/>```./getURL.sh```
<br/>If you didn’t use CP4I as the project name, you can append your custom project name to the getURL command. For example:
