...
![banner](./images/Observe CP4I 300 Script GitHub banner 7-19-23.jpg)
...
Today we will see how a bank can monitor the Cloud Pak for Integration. The bank built its mobile application using a microservices architecture, with independently developed components working together to provide customers access to their accounts. Instana automatically discovers the relationship between these components by tracking messages as they pass through. This tracking is based on Open Telemetry and designed to minimize the performance impact of collecting this data. The application uses a collection of technology including MQ, App Connect Enterprise, API Connect, Node.js, WebSphere Liberty and DB2. 

<br/>

We will start by seeing how Instana provides application performance monitoring for these components, using MQ as an example to examine its activity and health. Next we'll see how the bank is alerted to a live production issue. They will visualize the banking application that is experiencing the issue, with auto-correlated events highlighted within the context of that application. The team will drill down into the root cause to understand how to resolve the issue and prevent it from happening in the future.
...
| **Action** &nbsp; 1.1.1 | Show the Instana home screen and explain each category.<br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-using-instana-to-observe-cloud-pak-for-integration/images/1-1-1-instana-home-screen.png" width="800" /> |
...
| **Action** &nbsp; 1.2.1 | Click the **infrastructure** icon.<br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-using-instana-to-observe-cloud-pak-for-integration/images/1-2-1-infrastructure-icon.png" width="800" /> |
...
| **Action** &nbsp; 1.2.3 | Zoom into the **cp4i** category and hover your mouse over each server to show the components. <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-using-instana-to-observe-cloud-pak-for-integration/images/1-2-3-cp4i-category.png" width="800" /> |
| **Action** &nbsp; 1.2.4 | As you hover over each server, stop when you see **IBM MQ Queue Manager** within the list.<br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-using-instana-to-observe-cloud-pak-for-integration/images/1-2-4-mq-dashboard.png" width="800" /> |
| **Action** &nbsp; 1.2.5 | Click the server with IBM MQ and scroll down to view the components installed on the server. <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-using-instana-to-observe-cloud-pak-for-integration/images/1-2-5-components.png" width="800" /> |
| **Action** &nbsp; 1.2.6 | Click **Open Dashboard**. <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-using-instana-to-observe-cloud-pak-for-integration/images/1-2-6-open-dashboard.png" width="800" /> |
...
| **Action** &nbsp; 1.3.1 | Expand the **IBM MQ Queue Manager** section (1) and click the link (2).<br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-using-instana-to-observe-cloud-pak-for-integration/images/1-3-1-link.png" width="800" /> |
...
| **Action** &nbsp; 1.3.3 | Click the top queue.<br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-using-instana-to-observe-cloud-pak-for-integration/images/1-3-3-click-queue.png" width="800" /> |
| **Action** &nbsp; 1.3.4 | Point out the **queue attributes** (1), **number of messages processed** (2) and **old message on the queue** (3). <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-using-instana-to-observe-cloud-pak-for-integration/images/1-3-4-details.png" width="800" /> |
...
| **Action** &nbsp; 2.1.2 | Click the **Application** icon (1), and select **Banking App** (2) from the table.<br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-using-instana-to-observe-cloud-pak-for-integration/images/2-1-2-banking-app.png" width="800" /> |
| **Action** &nbsp; 2.1.3 | Show the **Erroneous Call Rate** (1) and **Latency** (2) graphs. Click the **Dependencies** (3) tab.<br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-using-instana-to-observe-cloud-pak-for-integration/images/2-1-3-graphs-dependencies.png" width="800" /> |
...
| **Action** &nbsp; 3.1.1 | Click the **Issues** button (1) and select **Sudden increase in the number of erroneous calls** (2). &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-using-instana-to-observe-cloud-pak-for-integration/images/3-1-1-sudden-increase.png" width="800" /> |
| **Action** &nbsp; 3.1.2 | Show the issue is still open (1). Click the **Analyze Calls** button (2). &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;  <br/><br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-using-instana-to-observe-cloud-pak-for-integration/images/3-1-2-analyze-calls-button.png" width="800" /> |
...
| **Action** &nbsp; 4.1.1 | Expand the **GET /api/balance** row, showing all the affected calls. &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-using-instana-to-observe-cloud-pak-for-integration/images/4-1-1-affected-calls.png" width="800" /> |
| **Action** &nbsp; 4.1.2 | Click the invocation at the top of the list. &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;  <br/><br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-using-instana-to-observe-cloud-pak-for-integration/images/4-1-2-click-call.png" width="800" /> |
...
| **Action** &nbsp; 4.2.1 | Highlight the **Sub Calls** (1), **Timeline** (2) and **Details** (3) section. <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-using-instana-to-observe-cloud-pak-for-integration/images/4-2-1-highlight.png" width="800" /> |
...
| **Action** &nbsp; 4.3.2 | Click the **Application** icon (1) and select the **Banking App** row (2). &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-using-instana-to-observe-cloud-pak-for-integration/images/4-3-2-banking-app.png" width="800" /> |(
| **Action** &nbsp; 4.3.3 | Point out that the **Calls** (1), **Erroneous Call Rate** (2) and **Latency** (3) have returned back to normal. &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-using-instana-to-observe-cloud-pak-for-integration/images/4-3-3-normal.png" width="800" /> |
...
You’ve seen how Instana can help make the process of identifying problems and finding their root cause frictionless across technology stacks. Since Instana automates so many of the manual and labor-intensive aspects of the process, you do not need to worry about instrumenting observability or constantly monitoring for problems. And when problems do arise, all the trace data is there at your fingertips, assuring issues are resolved swiftly to minimize the impact to end-users.
