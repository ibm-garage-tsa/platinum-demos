...
| **Action** &nbsp; 1.2.2 | Point out that the servers are configured for this Instana instance. The servers are distributed across the globe: a server in **us-central** (1), while another is in **westeurope** (2).<br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-using-instana-to-observe-cloud-pak-for-integration/images/1-2-2-servers.png" width="800" /> |
| **Action** &nbsp; 1.2.3 | Zoom into the **america-cp4i** category and hover your mouse over each server to show the components. <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-using-instana-to-observe-cloud-pak-for-integration/images/1-2-3-cp4i-category.png" width="800" /> |
