...
<InlineNotification><strong>WARNING</strong>: July 25, 2022. The process mining server is currently having a problem rendering the analytics dashboards. Until it is fixed, you will need to skip section 5.2 and proceed to Step 6.  We will provide daily updates until  this is resolved. </InlineNotification>
