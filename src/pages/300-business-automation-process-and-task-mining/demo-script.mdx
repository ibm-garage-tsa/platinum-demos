...
<InlineNotification><strong>WARNING</strong>: July 26, 2022. The process mining server is currently having a problem rendering the analytics dashboards. Until it is fixed, you will need to skip section 5.2 and proceed to step 6. We will provide daily updates until this is resolved. </InlineNotification>
...
| **Action** &nbsp; 5.2.2 | In the **Time Consumed by Application** panel at the bottom, hover over any of the activities to see more details, including what applications are used. <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-business-automation-process-and-task-mining/images/panel.png" width="800" /> |
| **Narration** | We also see the time spent in the individual applications used to complete the 'BO Service Closure' task. <br/><br/> We'll exit the task mining view so we can move on to simulation. |
| **Action** &nbsp; 5.2.3 | Click the **Views** icon (1) and then **Process mining** (2). <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-business-automation-process-and-task-mining/images/dashboard-process-mining.png" width="800" /> |
