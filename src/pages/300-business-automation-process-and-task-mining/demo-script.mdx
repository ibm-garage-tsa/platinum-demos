...
| **Narration** | When we select the first process variant, the visualization updates to display the steps unique to that variant. This path is taking almost twenty days on average to complete each account closure request. The most frequent variant is not meeting our requirement to complete the account closure within fourteen days. |
...
| **Action** &nbsp; 3.2.2 | Click **Close**. <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-business-automation-process-and-task-mining/images/rules-overview.png" width="800" /> |
| **Action** &nbsp; 3.2.3 | Click the **Model** tab. <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-business-automation-process-and-task-mining/images/click-model.png" width="800" /> |
...
| **Action** &nbsp; 4.1.1 | Click the **BO Service Closure** activity (1). Then click **Statistics** (2). <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-business-automation-process-and-task-mining/images/bo_service_closure.png" width="800" /> |
...
| **Action** &nbsp; 4.1.2 | Close the window by clicking the **X** in the corner. <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-business-automation-process-and-task-mining/images/bo-service-closure.png" width="800" /> |
| **Action** &nbsp; 4.1.3 | Click the **BO Service Closure** activity. Click **Task Mining**. <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-business-automation-process-and-task-mining/images/task-mining.png" width="800" /> |
...
| **Action** &nbsp; 4.1.4 | Click **Frequency** (1), then **Average Duration** (2), and then the **Case Variant** (double arrow) icon (3) to view variants. <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-business-automation-process-and-task-mining/images/average-duration.png" width="800" /> |
...
| **Action** &nbsp; 4.2.1 | Click the **Boxes** icon in the top right corner of your screen (1). From the drop-down list, select **Analytics** (2). <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-business-automation-process-and-task-mining/images/analytics.png" width="800" /> |
...
| **Action** &nbsp; 5.1.1 | Click the **BPMN** tab (1) and then **Simulation** (2). <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-business-automation-process-and-task-mining/images/bpmn-2.png" width="800" /> |
| **Action** &nbsp; 5.1.2 | Select **New simulation** (1), provide a **Simulation title** (2), and click **Confirm** (3). <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-business-automation-process-and-task-mining/images/simulation.png" width="800" /> |
...
| **Action** &nbsp; 5.1.5 | Under **Robotic quote**, change the percentage of automation to **100%**. <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-business-automation-process-and-task-mining/images/percentage.png" width="800" /> |
