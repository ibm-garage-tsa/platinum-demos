...
1. Open the following URL in a browser on your local computer: <a href="https://10.0.0.4/signin#!/workspace" target="_blank" rel="noreferrer">https://10.0.0.4/signin#!/workspace</a> 
