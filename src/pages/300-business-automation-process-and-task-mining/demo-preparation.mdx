...
2. On the reservation form, be sure to select **Enable** for **VPN Access**. <br/><br/><InlineNotification>If you do not request to enable VPN access, you will not be able to access the Process mining workspace directly from a web browser on your local computer. </InlineNotification> <br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-business-automation-process-and-task-mining/images/prep-1.png" width="600" /><br/>
