...
### **WARNING**:     June 7, 2022. This demonstration’s 1-click installation occasionally fails. Should this occur, please raise a ticket on the <a href="https://www.ibm.com/mysupport" target="_blank" rel="noreferrer">IBM Support Portal</a> mentioning “1 click install”. We are working very closely with support, who will assist you in getting your environment running.
...
| **Action** &nbsp; 1.1.1 | Open Cloud Pak for Integration and click **IBM provided credentials (admin only)**. <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-low-code-integration-using-ai/images/mapping-assist-1-1-1.png" width="800" /> |
| **Action** &nbsp; 1.1.2 | Log in with your admin username and password. <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-low-code-integration-using-ai/images/mapping-assist-1-1-2.png" width="800" /> |
...
| **Action** &nbsp; 1.2.1 | Show the home page and click **View Capabilities**. <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-low-code-integration-using-ai/images/mapping-assist-1-2-1.png" width="800" /> |
...
| **Action** &nbsp; 1.3.1 | Show the **Integration capabilities** page and open the Designer (**ace-designer-demo**). <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-low-code-integration-using-ai/images/mapping-assist-1-3-1.png" width="800" /> |
...
| **Action** &nbsp; 2.1.1 | Click **Create flows for an API** (1). <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-low-code-integration-using-ai/images/mapping-assist-2-1-1.png" width="800" /> |
| **Action** &nbsp; 2.1.2 | In the API title, replace Untitled API with **Contact API** (2). In the model name, enter **Contact** and click **Create model** (3). <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-low-code-integration-using-ai/images/mapping-assist-2-1-2.png" width="800" /> |
...
| **Action** &nbsp; 2.3.1 | On the **Select an operation to add** combobox, select **Create Contact** (1). Then, click **Implement flow** (2). &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-low-code-integration-using-ai/images/mapping-assist-2-3-1.png" width="800" /> |
...
| **Action** &nbsp; 3.1.1 | Click the **Response** node (1). <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-low-code-integration-using-ai/images/mapping-assist-3-0-1.png" width="800" /> |
| **Action** &nbsp; 3.1.2 | Enter **ID** in the **ID** field (2), and select the **Request ID** object (3). <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-low-code-integration-using-ai/images/mapping-assist-3-0-2.png" width="800" /> |
...
| **Action** &nbsp; 3.2.1 | Click the **Plus** icon (1). Search for the **Salesforce** connector (2). <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-low-code-integration-using-ai/images/mapping-assist-3-1-1.png" width="800" /> |
| **Action** &nbsp; 3.2.2 | From your pre-configured Salesforce connector, select **Retrieve contacts** (3). <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-low-code-integration-using-ai/images/mapping-assist-3-1-2.png" width="800" /> |
| **Action** &nbsp; 3.2.3 | Select **Process 10 items from the collection** (4). <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-low-code-integration-using-ai/images/mapping-assist-3-1-3.png" width="800" /> |
...
| **Action** &nbsp; 3.3.1 | Click the **Plus** icon (1). <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-low-code-integration-using-ai/images/mapping-assist-3-2-1.png" width="800" /> |
| **Action** &nbsp; 3.3.2 | Then, open the **Toolbox** tab (2) and select the **For each** statement (3). <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-low-code-integration-using-ai/images/mapping-assist-3-2-2.png" width="800" /> |
| **Action** &nbsp; 3.3.3 | Enter **Contacts** in the **Select the collection of items to process** field (4), and select the **Salesforce Contacts** object (5). <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-low-code-integration-using-ai/images/mapping-assist-3-2-3.png" width="800" /> |
...
| **Action** &nbsp; 3.4.1 | In the **For each** loop, click the **Plus** icon (1). <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-low-code-integration-using-ai/images/mapping-assist-3-3-1.png" width="800" /> |
| **Action** &nbsp; 3.4.2 | In the **Applications** tab, search for the **Insightly** connector (2). <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-low-code-integration-using-ai/images/mapping-assist-3-3-2.png" width="800" /> |
| **Action** &nbsp; 3.4.3 | Select the **Create contact** operation (3). <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-low-code-integration-using-ai/images/mapping-assist-3-3-3.png" width="800" /> |
...
| **Action** &nbsp; 4.1.1 | Point out Mapping Assist's **[20+] suggestions** (1) and click **View suggestions** (2). <br/><br/> <InlineNotification>NOTE: The exact number of suggestions may vary.</InlineNotification> <br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-low-code-integration-using-ai/images/mapping-assist-4-1-1.png" width="800" /> |
...
| **Action** &nbsp; 4.2.1 | Show the list of suggestions (1) and click **Apply [20+] suggestions** (2). <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-low-code-integration-using-ai/images/mapping-assist-4-2-1.png" width="800" /> |
...
| **Action** &nbsp; 4.4.1 | Click the **Other address postcode** field (1). Select the **Other Zip/Postal Code** mapping suggestion (2). <br/><br/><InlineNotification> NOTE: If you have any other field (e.g., date of birth) that is not mapped to the **For each** element (orange icon), replace it to use the **For each** element.</InlineNotification> <br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-low-code-integration-using-ai/images/mapping-assist-4-3-1.png" width="800" /> |
...
| **Action** &nbsp; 4.5.1 | On the **Assistant name** field, click the **Assistant's Name** mapping and select **Generate transformation** (1). <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-low-code-integration-using-ai/images/mapping-assist-4_4_1.png" width="800" /> |
| **Action** &nbsp; 4.5.2 | On the **Generate transformation** dialog, enter **John Lennon** as the first source name, and enter **J. Lennon** under **'Assistant name' examples (target)**. Repeat the same steps to include four more assistants' names using the same transformation format (e.g., Paul McCartney, P. McCartney; George Harrison, G. Harrison; Ringo Starr, R. Starr; Pete Best, P. Best) (2). Click **Generate transformation** (3), and click **Insert transformation** (4). <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-low-code-integration-using-ai/images/mapping-assist-4_4_2.png" width="800" /> |
| **Action** &nbsp; 4.5.3 | Click **Done** (5). <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-low-code-integration-using-ai/images/mapping-assist-4_4_3.png" width="800" /> |
...
| **Action** &nbsp; 5.1.1 | Open your **Insightly** home page (1). <br/><br/> Open the **Contacts** view (2). <br/><br/> <img src="https://github.com/ibm-garage-tsa/platinum-demos/raw/058aa7c91c74253c21057da730d8d62fcd82a8de/src/pages/300-integration-low-code-integration-using-ai/images/mapping-assist-5_1_1.png" width="800" /> |
| **Action** &nbsp; 5.1.2 | Notice that there are approximately 20 pre-created contacts, each with pictures (3). <br/><br/> <img src="https://github.com/ibm-garage-tsa/platinum-demos/raw/058aa7c91c74253c21057da730d8d62fcd82a8de/src/pages/300-integration-low-code-integration-using-ai/images/mapping-assist-5_1_2.png" width="800" /> |
...
| **Action** &nbsp; 5.2.1 | Go back to Cloud Pak for Integration's **App Connect Designer** page. Start your flow (1). &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <br/><br/> <img src="https://github.com/ibm-garage-tsa/platinum-demos/raw/058aa7c91c74253c21057da730d8d62fcd82a8de/src/pages/300-integration-low-code-integration-using-ai/images/mapping-assist-5_2_1.png" width="800" /> |
| **Action** &nbsp; 5.2.2 | Open the **Test** tab (2). Click **POST /Contact** (3) and open the **Try it** tab (4). &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <br/><br/> <img src="https://github.com/ibm-garage-tsa/platinum-demos/raw/058aa7c91c74253c21057da730d8d62fcd82a8de/src/pages/300-integration-low-code-integration-using-ai/images/mapping-assist-5_2_2.png" width="800" /> |
| **Action** &nbsp; 5.2.3 | Scroll down to see the body field, and click **Generate** (5) to create some dummy body content. Click **Send** (6), and you should see a **201 Created** response (7). &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <br/><br/> <img src="https://github.com/ibm-garage-tsa/platinum-demos/raw/058aa7c91c74253c21057da730d8d62fcd82a8de/src/pages/300-integration-low-code-integration-using-ai/images/mapping-assist-5_2_3.png" width="800" /> |
...
| **Action** &nbsp; 5.3.1 | Go back to Insightly's **Contacts** page and refresh the page (1). <br/><br/> <img src="https://github.com/ibm-garage-tsa/platinum-demos/raw/058aa7c91c74253c21057da730d8d62fcd82a8de/src/pages/300-integration-low-code-integration-using-ai/images/mapping-assist-5_3_1.png" width="800" /> |
| **Action** &nbsp; 5.3.2 | Explore the new contacts (without the sample_data tags) (2). <br/><br/> <img src="https://github.com/ibm-garage-tsa/platinum-demos/raw/058aa7c91c74253c21057da730d8d62fcd82a8de/src/pages/300-integration-low-code-integration-using-ai/images/mapping-assist-5_3_2.png" width="800" /> |
| **Action** &nbsp; 5.3.3 | Click one of the contacts without a picture (3), and show the new format of **Assistant Name** based on the function we defined in the flow (4). <br/><br/> <img src="https://github.com/ibm-garage-tsa/platinum-demos/raw/058aa7c91c74253c21057da730d8d62fcd82a8de/src/pages/300-integration-low-code-integration-using-ai/images/mapping-assist-5_3_3.png" width="800" /> |
...
Thank your for attending this presentation.
