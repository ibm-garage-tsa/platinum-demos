...
| **Action** | You may or may not see this situation. When this happens a **warning** message is shown. You need to resolve any/all fields where this occurs.<br/><br/>**Delete** the field name that is currently mapped into the field that has the warning. <br/><br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-integration-low-code-integration-using-ai/images/Error_screen.png" width="600" /><br/> |
| **Action** | Click on the selection list icon next to the field (1) and select the mapping option listed with the “For Each” option from the displayed list (2). Repeat these steps for each field that has a warning. <br/><br/><img src="https://github.com/ibm-garage-tsa/platinum-demos/blob/master/src/pages/300-integration-low-code-integration-using-ai/images/Selection_list.png?raw=true" width="600" /><br/> |
...
| **Screenshots** | <br/> ![](images/mapping-assist-5_2_1.png) <br/> ![](images/mapping-assist-5_2_2.png) <br/> ![](images/mapping-assist-5_2_3.png) |
