...
<br/>a. Delete any contacts that were added in Insightly.<br/>b. Reinstall Cloud Pak for Integration to ensure you have a clean environment. Follow the "Request your demo environment" instructions from the "Prepare to give the demo" section above.<br/><br/>
