...
![banner](./images/Low-code-integration-300-Prep.jpg)
<span id="top"></span>
...
Now, let’s set up Insightly. Insightly is a cloud-based customer relationship management (CRM) and project management solution for managing leads, contacts, organizations, and opportunities, as well as automating your workflow.
