...
| **Narration** | Here’s a new version of the workflow. The integration automatically gathers the customer account information in the second step of the process. The bank is able to remove the subsequent manual task (*Gather Account Info*).  Instead of having to assign the task to an account specialist, the new integration aggregates all the information needed to make a decision. Workflow routes the request directly to an account approver. |
...
| **Action** &nbsp; 3.2.13 | Click the **Data Mapping** tab (1). Click the **Automap** icon (2) under **Input Mapping**. <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-enhancing-ba-with-integration/images/3-2-17.png" width="800" /> |
...
| **Action** &nbsp; 3.2.17 | Under **API Key Mapping**, enter the API key surrounded by double quotes (e.g., "**API-KEY-GOES-HERE**"). <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-enhancing-ba-with-integration/images/3-2-21.png" width="800" /> |
...
| **Action** &nbsp; 3.2.21 | Click **Data** (1) to open the variables. Click the **Accounts_findById** variable and then the **savingAccount** property (2) to show that the integration returned the customer account information. <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-enhancing-ba-with-integration/images/3-2-25.png" width="800" /> |
