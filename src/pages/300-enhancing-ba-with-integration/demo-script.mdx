...
| **Action** &nbsp; 1.2.4 | Select the **Account Type** (1). Enter the **Customer Account Number** (2), **First Name** (3), and **Last Name** (4). Click **Next** (5). <br/><br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-enhancing-ba-with-integration/images/1-2-4.png" width="800" /> |
...
| **Action** &nbsp; 1.2.6 | Run the most recent **Gather Account Info** task by clicking the task name. <br/><br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-enhancing-ba-with-integration/images/1-2-6.png" width="800" /> |
...
| **Action** &nbsp; 2.1.2 | Open the **Properties** view. <br/><br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-enhancing-ba-with-integration/images/2-2-2.png" width="800" /> |
| **Action** &nbsp; 2.1.3 | Show the **Properties**, as highlighted in the screenshot below. <br/><br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-enhancing-ba-with-integration/images/2-2-3.png" width="800" /> |
| **Action** &nbsp; 2.1.4 | Open the **Operations** view. <br/><br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-enhancing-ba-with-integration/images/2-2-4.png" width="800" /> |
...
| **Action** &nbsp; 2.1.6 | Scroll through and explain the flow, as highlighted in the narration below. Click the **Request** again. <br/><br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-enhancing-ba-with-integration/images/2-2-6.png" width="800" /> |
| **Narration** | The bank’s flow starts by receiving the customer’s ID as part of the API URL. Integration Designer automatically creates an API 'request' and 'response' for the API flow. |
| **Action** &nbsp; 2.1.7 | Show the **Request** dialog (1). Click the **Customer Account** step (2). <br/><br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-enhancing-ba-with-integration/images/2-2-7.png" width="800" /> |
| **Narration** | Next, Focus Bank invokes the customer account retrieval API. The customerId is passed in from the inbound request. |
| **Action** &nbsp; 2.1.8 | Explore the **Customer Account** step (1), as highlighted in the narration below. Click **IBM MQ** (2). <br/><br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-enhancing-ba-with-integration/images/2-2-8.png" width="800" /> |
...
| **Action** &nbsp; 2.1.9 | Explore the **IBM MQ** step (1), as highlighted in the narration below. Click the second **IBM MQ** step in the flow (2). <br/><br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-enhancing-ba-with-integration/images/2-2-9.png" width="800" /> |
...
| **Action** &nbsp; 2.1.10 | Explore the **IBM MQ** step (1), as highlighted in the narration below. Click the **JSON Parse** step (2). <br/><br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-enhancing-ba-with-integration/images/2-2-10.png" width="800" /> |
...
| **Action** &nbsp; 2.1.11 | Explore the **JSON Parser** step (1), as highlighted in the narration below. Click the **Response** step (2). <br/><br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-enhancing-ba-with-integration/images/2-2-11.png" width="800" /> |
...
| **Action** &nbsp; 2.1.12 | Explore the **Response** step (1), as highlighted in the narration below. Click **Done** (2). <br/><br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-enhancing-ba-with-integration/images/2-2-11.png" width="800" /> |
...
| **Action** &nbsp; 2.2.1 | Open the **Test** tab (1). Open **GET /Accounts/{customerId}** (2) and click **Try it** (3). <br/><br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-enhancing-ba-with-integration/images/2-3-1.png" width="800" /> |
| **Action** &nbsp; 2.2.2 | Enter '**1234567890**' (1) as the **customerId**, and click **Send** (2). <br/><br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-enhancing-ba-with-integration/images/2-3-2.png" width="800" /> |
| **Action** &nbsp; 2.2.3 | Point out the **Response** details, as highlight in the screenshot below. <br/><br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-enhancing-ba-with-integration/images/2-3-2.png" width="800" /> |
...
| **Action** &nbsp; 3.2.3 | Click the **File** icon (1) and select the **.yaml** file you just downloaded (2). Click **Next** (3). <br/><br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-enhancing-ba-with-integration/images/3-2-3.png" width="800" /> |
...
| **Action** &nbsp; 3.2.6 | Open the existing external service named **Accounts** in the process library. <br/><br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-enhancing-ba-with-integration/images/3-2-6.png" width="800" /> |
...
| **Action** &nbsp; 3.2.21 | Click **Data** (1) to open the variables. Click the **Accounts_findById** variable (2) and then **savingAccount** (3) to show that the integration returned the customer account information. <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-enhancing-ba-with-integration/images/3-2-25.png" width="800" /> |
...
| **Action** &nbsp; 3.2.23 | Click the **Gather Account Info** activity (1). Select the **Data Mapping** tab (2). Under Input Mapping, click the **Variable Picker** icon (3). Open **request** (4) and then **customer** (5). Select **id** (6). <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-enhancing-ba-with-integration/images/3-2-27.png" width="800" /> |
| **Action** &nbsp; 3.2.24 | Under **Output Mapping**, click the **Variable Picker** icon (1). Open **request** (2) and then **customer** (3). Select **accounts** (4). <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-enhancing-ba-with-integration/images/3-2-28.png" width="800" /> <br/><br/> The resulting data mapping is displayed. <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-enhancing-ba-with-integration/images/3-2-29.png" width="800" /> |
...
| **Action** &nbsp; 4.1.3 | Select the **Account Type** (1). Enter the **Customer Account Number** (2), **First Name** (3), and **Last Name** (4). Click **Next** (5). <br/><br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-enhancing-ba-with-integration/images/4-1-4.png" width="800" /> |
