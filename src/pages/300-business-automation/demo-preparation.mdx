...
<img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-business-automation/images/Stu_4.2.2_Self_Install.png" width="800" /><br/>
...
Click on **Start Workflow** and select the **Quote Exception** tile (may need to scroll down).<br/><br/>Select **Tip**. Then, select **Launch**. Repeat **two times** to generate two tasks. <br/><br/><img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-business-automation/images/Stu_4.4.3_Self_install.png" width="800" /><br/>You should now see (at least) five tasks in the task inbox.<br/><br/>
