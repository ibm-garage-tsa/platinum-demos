...
In this step, we will open the task list view in a new tab and populate some in-flight process instances so there are some tasks in the inbox. To do this, go to the **Refund Request Demo Launcher**, and click on the **Refund Investigator**.<br/><br/>
