...
| **Action** &nbsp; 1.2.3 | Zoom into the **america-cp4i** category and hover your mouse over each server to show the components. <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-observing-your-integration-estate-with-instana/images/1-2-3-cp4i-category.png" width="800" /> |
