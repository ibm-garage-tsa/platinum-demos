...
| **Action** &nbsp; 1.3.2 | <InlineNotification>Two queue managers are used for the banking application. You could be in either at this point, depending on which machine and queue manager you selected previously. If the IBM MQ instance starts with **corebanking** (1), search for BALANCE queue in the next step. Otherwise, search for AUDIT.</InlineNotification> <br/>Scroll down to the **Queues** table (2), and type either **balance** or **audit** into the **Search bar** (as explained in the note above, you might have either choice) (3). <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-observing-your-integration-estate-with-instana/images/1-3-2-search.png" width="800" /> |
...
| :--- | :--- |
| **Narration** | To investigate the team navigates into the affected API invocations. Instana traces every step of an invocation, without sampling, assuring all components are traced and allowing each technology area to be investigated. The team selects one of the invocations for further analysis.  |
...
You’ve seen how Instana can help make the process of identifying problems and finding the root cause of those problems frictionless across technology stacks. Since Instana automates so many of the manual and labor-intensive aspects of the process, you do not need to worry about instrumenting observability or constantly monitoring for problems. And when problems do arise, all the trace data is there at your fingertips to dig into, assuring the end-user's impact is minimized and continuously improved.
