...
| **Action** &nbsp; 1.3.2 | <inlinenotification>If the IBM MQ instance starts with corebanking, search for <strong>BALANCE</strong> queue in the next step, else search for <strong>AUDIT</strong>.</inlinenotification> Scroll down to the **Queues** table (1), and type either **balance** or **audit** into the Search bar (2). <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-observing-your-integration-estate-with-instana/images/1-3-2-search.png" width="800" /> |
...
| **Action** &nbsp; 3.1.2 | Show the issue is still open (1), and click on the **Analyze Calls** button (2). <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-observing-your-integration-estate-with-instana/images/3-1-2-analyze-calls-button.png" width="800" /> |
