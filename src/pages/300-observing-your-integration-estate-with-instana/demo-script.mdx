...
export const Title = () => (
  <span>
    <h1 style=“font-size:60px;“> Observing your integration estate with Instana  <br/> 300-level live demo</h1>
  </span> );
...
Today we will see how a bank can visualize their cloud native applications and integration estate. This includes understanding the health of the infrastructure, components, and live transactions. 
...
| :--- | :--- |
| **Narration** | Focus Bank have embraced a microservices architecture for their application development. IBM MQ provides the reliable communication, and IBM App Connect Enterprise the glue between microservices. The SRE (Site Reliability Engineer) and the application and integration teams need to be able to observe the environment and be alerted to issues that occur. They need to work together, collaboratively to assure the Bank’s applications are available.<br/><br/>IBM Instana provides a full-stack observability platform, which gives deep insights for the SRE, application and integration teams. The home screen shows five categories, which act as launch points based on your role:<br/><br/>1.	**Website & Mobile Apps** shows the end user interaction and their experiences.<br/><br/>2. **Applications** focuses on the server-side of the application, such as the number of calls, latency, and error call rate. <br/><br/>3. **Platform** shows the target deployment environments that are used for the applications, such as Kubernetes, Cloud Foundry and vSphere.<br/><br/>4.	**Infrastructure** with the physical and virtualized servers underpinning the applications.<br/><br/>5. **Events** that the operational team should be reviewing. |
| **Action** &nbsp; 1.1.1 | Show the Instana home screen, slowly scrolling down pausing to explain each category. <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-observing-your-integration-estate-with-instana/images/1-1-1-instana-home-screen.png" width="800" /> |

| **1.2** | **View the entire network ** |
| :--- | :--- |
| **Narration** | Let’s look at Focus Bank’s infrastructure. <br/><br/>Instana provides an infrastructure map across the entire estate. This is automatically discovered by the Instana agents, with additional user categorization possible. <br/><br/>In Instana, servers are referred to as hosts. These hosts include those used for the integration technology as well as the microservices that make up the application. This view is not limited to a single data center - it is a global hybrid multi-cloud view where hosts are on-premise and in public cloud environments.<br/><br/>If we click on one of the hosts, this will show the hardware specification, immediately highlighting any issues with the infrastructure. In this case, there are none. Scrolling down we can see the components installed. In this case you can see IBM MQ, IBM App Connect Enterprise and several others. <br/><br/>Let’s click into the host dashboard to take a deeper look. |
| **Action** &nbsp; 1.2.1 | Click on the infrastructure icon.<br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-observing-your-integration-estate-with-instana/images/1-2-1-infrastructure-icon.png" width="800" /> |
...
| **Action** &nbsp; 1.2.3 | Zoom into the **cp4i** category and hover over the servers, hovering your mouse over each to show the components. <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-observing-your-integration-estate-with-instana/images/1-2-3-cp4i-category.png" width="800" /> |
| **Action** &nbsp; 1.2.4 | We will show the IBM MQ dashboard, so continue hovering over the servers until you see **IBM MQ Queue Manager** within the list.<br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-observing-your-integration-estate-with-instana/images/1-2-4-mq-dashboard.png" width="800" /> |
| **Action** &nbsp; 1.2.5 | Click on the server with IBM MQ and scroll down to view the components installed on the server. <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-observing-your-integration-estate-with-instana/images/1-2-5-components.png" width="800" /> |
| **Action** &nbsp; 1.2.6 | Click on Open Dashboard. <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-observing-your-integration-estate-with-instana/images/1-2-6-open-dashboard.png" width="800" /> |
...
| **Action** &nbsp; 1.3.1 | Expand the **IBM MQ Queue Manager** (1) section and click on the link (2).<br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-observing-your-integration-estate-with-instana/images/1-3-1-link.png" width="800" /> |
| **Narration** | Here we can see the details for the IBM MQ Queue Manager. This is the default view provided automatically. The MQ agent understands how to collect the metrics, and what views will be useful for the user. The live and historical metrics show the number of connections into the queue manager, the number of messages, and configured MQ objects. If we look at the queues table, we can quickly filter and see the current state, such as the number of messages on the queue, and the time of the last put and get. We can dig deeper into all the queues, topics and applications accessing the queue manager, and see the details. |
| **Action** &nbsp; 1.3.2 | <inlinenotification>If the IBM MQ instance starts with corebanking, search for <strong>BALANCE</strong> queue in the next step. Otherwise, search for <strong>AUDIT</strong>.</inlinenotification> Scroll down to the **Queues** table (1), and type either **balance** or **audit** into the Search bar (2). <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-observing-your-integration-estate-with-instana/images/1-3-2-search.png" width="800" /> |
| **Action** &nbsp; 1.3.3 | Click on a queue.<br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-observing-your-integration-estate-with-instana/images/1-3-3-click-queue.png" width="800" /> |
| **Action** &nbsp; 1.3.4 | Show the details for the queue.<br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-observing-your-integration-estate-with-instana/images/1-3-4-details.png" width="800" /> |
...
| **Action** &nbsp; 2.1.2 | Click on the **Application** icon (1), and select **Banking App** (2) from the table.<br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-observing-your-integration-estate-with-instana/images/2-1-2-banking-app.png" width="800" /> |
| **Action** &nbsp; 2.1.3 | Show the **Erroneous Call Rate** (1) and **latency** (2) graphs. Click on the **Dependencies** (3) tab.<br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-observing-your-integration-estate-with-instana/images/2-1-3-graphs-dependencies.png" width="800" /> |
...
| **Action** &nbsp; 3.1.1 | Click on the **Issues** button (1) and select **Sudden increase in the number of erroneous calls** (2).<br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-observing-your-integration-estate-with-instana/images/3-1-1-sudden-increase.png" width="800" /> |
...
| :--- | :--- |
| **Narration** | They navigate into the effected API calls to drill down into the cause. <br/><br/>All components are traced, and nothing gets missed due to Instana tracing 100% of the calls. This allows the team to analyze all the calls during the failure and ensure nothing is lost. <br/><br/>They see a timeline and table for all the calls experiencing failures. The team selects one of the invocations for further analysis. |
...
| **Action** &nbsp; 4.1.2 | Click on one of the calls.<br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-observing-your-integration-estate-with-instana/images/4-1-2-click-call.png" width="800" /> |

| **4.2** | **Understand the impact and source of the incident ** |
| :--- | :--- |
| **Narration** | The teams sees a hierarchical view of the invocation, all the way from the end-users web browser to the backend system. There are a number of sub-calls traced, and several are experiencing an undesirable delay, and/or error. The timeline plots the duration of each sub call, immediately highlighting to the team where the issue may be located. |
...
| **Action** &nbsp; 4.3.2 | Click on the **Application** icon (1)and select the **Banking App** row (2).  <br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-observing-your-integration-estate-with-instana/images/4-3-2-banking-app.png" width="800" /> |
| **Action** &nbsp; 4.3.3 | Show how the errors and latency ratios have returned back to normal.<br/><br/> <img src="https://raw.githubusercontent.com/ibm-garage-tsa/platinum-demos/master/src/pages/300-observing-your-integration-estate-with-instana/images/4-3-3-normal.png" width="800" /> |
